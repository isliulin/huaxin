package com.topvision.videodemo.encoder;
/*
...
public class MediaMuxerWrapper {
	...
	public MediaEncoder mVideoEncoder, mAudioEncoder;
	...
	public MediaMuxerWrapper(String ext) throws IOException {
		...
		try {
			...
			mOutputPath = Environment.getExternalStorageDirectory().getAbsolutePath()+"/"+getDateTimeString()+".mp4";
