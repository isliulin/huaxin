...
public class MediaMuxerRunnable extends Thread {
    ...
    private void readyStart() throws IOException {
       ...
       // readyStart(Environment.getExternalStorageDirectory().getPath()+"/AV_"+ TimeUtils.milliseconds2String2( System.currentTimeMillis())+".mp4", false);
        readyStart(VideoSet.videoFilePath, false);
    }
