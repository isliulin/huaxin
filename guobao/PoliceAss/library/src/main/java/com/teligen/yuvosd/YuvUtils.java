 ...
 * <p/>
 * 作者：Administrator on 2017/8/21 19:57
 * <p/>
 * 邮箱：xjs250@163.com
 * <p/>
 * 创建日期：2017/8/21 19:57
 * <p/>
 * 描述：
 * =====================================================================================
 */
...
public class YuvUtils {
     ...
     * @param height 分辨率的高
     */
    public static native void swapYV12ToNV21(byte[] src,byte[] dest,int width, int height);
     ...
     * @param colorFormat
     */
    public static native void addOsdToI420(byte[] src,int width,int height ,String date,String loc);
