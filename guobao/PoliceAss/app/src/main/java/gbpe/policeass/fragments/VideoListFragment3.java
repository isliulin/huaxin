 ...
 */
public class VideoListFragment3 extends BaseFragment implements View.OnClickListener{
    ...
    private TextView tv_sc,tv_mark;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerAdapter<String>(mContext, soundPaths, R.layout.item_list_image) {
            ...
            public void convert(RecycleHolder holder, String data, int position) {
                ...
                String fileSize = FileSizeUtil.getFileSize(data);
                ...
                LinearLayout ll = (LinearLayout)holder.findView(R.id.ll_item_bg);
                if (list.size() != 0) {
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        adapter.setOnItemClickListener(new RecyclerAdapter.OnItemClickListener() {
            ...
            public void OnItemClickListener(View view, int position) {
                ...
                }else
                {
                    ...
                    // bundle.putString("filePath",soundPaths.get(position));
                    // bundle.putString("filePath",soundPaths.get(position));
                    //bundle.putStringArrayList("filepath",(ArrayList<String>) soundPaths);
                    bundle.putStringArrayList(VideoPlayFragment.BUNDLE_FILE_PATH,(ArrayList<String>) soundPaths);
                    //bundle.putInt("position",position);
                    bundle.putInt(VideoPlayFragment.BUNDLE_FILE_POSITION,position);
                    // bundle.putParcelableArrayList("filePaths",(ArrayList<String>)soundPaths);
                    // activity.showFragment2(VideoListFragment3.this,PlayVideoFragment.class,"PlayVideoFragment",bundle,true);
                    activity.showFragment2(VideoListFragment3.this,VideoPlayFragment.class,
 ...
 //======================================================================================================================
    ...
    private void setSelectNum() {//标题栏上的textview动态记录被选中的item的数目。
        ...
        String str = getString(R.string.selected)+num+getString(R.string.items);
...
//    //全选
    ...
    public void initDatas() {
        ...
        Log.d(TAG, "sort soundPaths");
        // add by ycb sort the items
        Collections.sort(soundPaths, new Comparator<String>() {
            @Override
        ...
        if (soundPaths.size()<=0) {
            ...
            Toast.makeText(getActivity(), R.string.no_video_available_tips, Toast.LENGTH_SHORT).show();
            return;
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_cancel:
                ...
                String str = getString(R.string.selected)+"1"+getString(R.string.items);
                numText.setText(str);
            ...
            case R.id.tv_sc:
                ...
                showDialog2(selectItems.size(),getString(R.string.upload_to_server),getString(R.string.confirm_to_upload));
                break;
            case R.id.tv_mark:
                id = R.id.tv_mark;
                //showDialog2(7,"标记为重点文件","确定全部标记？");
                showDialog2(7,getString(R.string.mark_as_important),getString(R.string.confirm_to_mark));
                break;
        }
    }
                    ...
                    case R.id.tv_mark:
                        ...
                        SelectHandleUtil.mark(getActivity(), getSelectedItems(), new SelectHandleUtil.OnFileHandleListener() {
                            ...
                            public void onFileHandleStart() {
                                ...
                                //dialog.setDesc("正在标记...");
                                dialog.setDesc(getString(R.string.marking));
                            }
                            @Override
                            ...
                            public void onAllFileHandleFinished() {
                                ...
                                Toast.makeText(getActivity(), R.string.mark_ok,Toast.LENGTH_SHORT).show();
                            }
                            @Override
    ...
    private List<String> getSelectedItems(){
        ...
        //for (String tmp: beSelectedItems) {
        //    Log.d(TAG, "item: "+tmp);
        //}
        // add by ycb sort the items
        Collections.sort(beSelectedItems, new Comparator<String>() {
            @Override
            public int compare(String o1, String o2) {
                return o2.compareTo(o1);
            }
