...
//sqlString.add("CREATE TABLE videos(_id INTEGER PRIMARY KEY AUTOINCREMENT,startTime TEXT, " +
//        "stopTime TEXT, size TEXT, path TEXT, name TEXT，latitude TEXT,longitude,TEXT);");
