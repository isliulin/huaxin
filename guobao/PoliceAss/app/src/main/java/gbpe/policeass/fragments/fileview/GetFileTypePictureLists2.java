...
import gbpe.policeass.zfysim.ImageDetailsActivity;
 ...
 * =====================================================================================
 */
public class GetFileTypePictureLists2 extends BaseFragment implements View.OnClickListener{
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        adapter.setOnItemClickListener(new RecyclerAdapter.OnItemClickListener() {
            ...
            public void OnItemClickListener(View view, int position) {
                ...
                }else
                {
                    ...
                    intent.putStringArrayListExtra("img_paths", (ArrayList<String>) soundPaths);
    ...
    public void initDatas() {
        ...
        if (soundPaths.size()<=0) {
            Toast.makeText(getActivity(), "还没有图片文件", Toast.LENGTH_SHORT).show();
            return;
        }
    }
    ...
    public  void getFilePath(String dirPath){
        ...
        for(int i = 0; i < files.length; i++) {
            if(files[i].isDirectory()) {
                ...
                if (files[i].getAbsolutePath().endsWith(Setup.imgFilePostfix)) {
