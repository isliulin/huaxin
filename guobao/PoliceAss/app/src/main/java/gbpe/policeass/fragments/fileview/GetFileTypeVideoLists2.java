package gbpe.policeass.fragments.fileview;
...
import gbpe.policeass.fragments.VideoPlayFragment;
 ...
 * <p/>
 * 作者：Administrator on 2017/9/19 11:07
 * <p/>
 * 邮箱：xjs250@163.com
 * <p/>
 ...
 */
 /*
 * Modified by ycb 2018/08/30
*/
public class GetFileTypeVideoLists2 extends BaseFragment implements View.OnClickListener{
	...
	private static final String TAG = "GetFileTypeVideoLists2";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		Log.i(TAG, "tag by ycb, create recycler view");
		
        adapter = new RecyclerAdapter<String>(mContext, soundPaths, R.layout.test) {
            @Override
            public void convert(RecycleHolder holder, String data, int position) {
               ...
               String fileTitle = fileName.substring(0,fileName.indexOf("."));
                ...
                if (message!=null&&message.length>=4){
                    ...
                    tv_title.setText(sb.toString()); //获取文件名);
                }else {
        ...
        adapter.setOnItemClickListener(new RecyclerAdapter.OnItemClickListener() {
            ...
            public void OnItemClickListener(View view, int position) {
                ...
                }else
                {
                    ...
                    activity.showFragment2(GetFileTypeVideoLists2.this,VideoPlayFragment.class,
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_cancel:
                selectItems.clear();
                numText.setText(R.string.select_one_item);
            ...
            case R.id.tv_sc:
                id = R.id.tv_sc;
                showDialog2(selectItems.size(), getString(R.string.upload_to_server),getString(R.string.sure_to_upload));
                break;
            case R.id.tv_mark:
                id = R.id.tv_mark;
                showDialog2(7,getString(R.string.mark_as_important),getString(R.string.mark_as_important_all));
                break;
        }
    }
                            ...
                            case R.id.tv_mark:
                                ...
                                SelectHandleUtil.mark(getActivity(), getSelectedItems(), new SelectHandleUtil.OnFileHandleListener() {
                                    ...
                                    public void onFileHandleStart() {
                                        ...
                                        dialog.setDesc(getString(R.string.mark_on_run_tips));
                                    }
                                    @Override
                                    ...
                                    public void onAllFileHandleFinished() {
                                        ...
                                        Toast.makeText(getActivity(), R.string.mark_over_tips, Toast.LENGTH_SHORT).show();
                                    }
                                    @Override
