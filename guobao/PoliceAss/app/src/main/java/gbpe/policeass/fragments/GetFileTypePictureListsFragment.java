 ...
 */
public class GetFileTypePictureListsFragment extends BaseFragment {
    View mView;
            ...
            public void conver(final ViewHolder holder, String s) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("image_position", holder.getPosition());
                        intent.putStringArrayListExtra("img_paths", (ArrayList<String>) videoNames);
