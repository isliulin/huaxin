...
extern char STMFLASH_BUF[STM_SECTOR_SIZE*2];
...
#define SNR1_MENU_CNT 6
#define SNR2_MENU_CNT 5
#define SNR3_MENU_CNT 3
...
extern s8 g_snrPageIndex;
extern char g_menuLevel;
extern s8 g_mpIndex[3];
extern const char g_snrPageCnt[3];
//extern char g_mP1Index;
//extern char g_mP2Index;
//extern char g_mP3Index;
...
extern void SnrProgressBar(u8 pa, u8 cl,u8 foc, u8 cnt);
