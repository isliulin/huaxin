...
#define OS_LOWEST_PRIO           19//12    //定义任务的最低优先级		不得大于 63
...
#define OS_TASK_CREATE_EXT_EN     0//by cbyi    //允许生成OSTaskCreateExt()                       
...
#define OS_TICKS_PER_SEC        1000//1000   //设置每秒的节拍数目                       
...
#define OS_TMR_CFG_NAME_SIZE     0//16    /*     Determine the size of a timer name                       */
