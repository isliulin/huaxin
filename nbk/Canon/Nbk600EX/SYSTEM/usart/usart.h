...
#define UART_ENCODE_SLAWAKE				0xA3
...
//extern void TrigerUartSend(void);
...
extern unsigned char UartSctSend(unsigned char id, unsigned char pa1, unsigned char pa2);
