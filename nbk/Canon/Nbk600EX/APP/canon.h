...
//#define WORKINGMODE_EXTA		3
//#define WORKINGMODE_EXTM		4

#define WORKINGMODE_EXTA		4
#define WORKINGMODE_EXTM		5
...
#ifdef _HP_SYN_
#define HP_PREFLASH_INTERVAL	(600-50)//450//150
#define HP_REALFLA_INTERVAL	7628//10200//5000//10200
...
#define RADIO_STATUE_SLAPRE		8
#define RADIO_STATUE_SLAFLA		9
#define RADIO_STATUE_MULTIFLASH    10
#define RADIO_STATUE_PREDAT		11
...
#define WLM_CHAN1_WIDTH		30//(45+20-40+15-10)//(32+84-38-10+6)//350//500//5
#define WLM_CHAN2_WIDTH		70//60//(90+20-40+15-25)//(32+131-38-10-8)//520//1300//9
//#define WLM_CHAN3_WIDTH		112//(140+20-40-6-12+10)//(31+178-38-10-8)//830//1700//16
//#define WLM_CHAN3_WIDTH		102
#define WLM_CHAN3_WIDTH		120
#define WLM_CHAN4_WIDTH		170//159//(200+10-40-10+20-31+10)//(28+214-38-10+4)//1100//2200//22
#define WLM_BIT1_INTERVAL  		(62-5)//(62-5-5)//(62-5-5)//(37+20)//600//5//600//5us triger delay
#define WLM_BIT0_INTERVAL		100//98//95//100//98//100//(95)//100//(95)//(100)
