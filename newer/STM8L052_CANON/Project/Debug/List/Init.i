...
uint16_t ADC_Buffer[((uint8_t) 0x0B)][((uint8_t) 0x05)]  = {0};
...
void ITC_Config(void)
{
    ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR1 = 0x00;  
    ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR2 = 0x00;
    ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR3 = 0x00;
    ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR4 = 0x00;
    ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR5 = 0x00;
    ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR6 = 0x00;
    ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR7 = 0x00;
    ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR8 = 0x00;
...
void GPIO_Config(void)
{
    ...
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5000), GPIO_Pin_2, GPIO_Mode_In_FL_No_IT);        
    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5000), GPIO_Pin_4, GPIO_Mode_In_FL_No_IT);        
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5000), GPIO_Pin_5, GPIO_Mode_In_FL_No_IT);        
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5000), GPIO_Pin_6, GPIO_Mode_In_FL_No_IT);        
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5000), GPIO_Pin_7, GPIO_Mode_Out_PP_Low_Fast);    
    
    
    
    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x501E), GPIO_Pin_3, GPIO_Mode_In_FL_No_IT);        
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_0, GPIO_Mode_Out_PP_Low_Fast);    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_1, GPIO_Mode_Out_PP_Low_Fast);    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_2, GPIO_Mode_Out_PP_Low_Fast);    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_3, GPIO_Mode_Out_PP_High_Fast);   
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_4, GPIO_Mode_Out_PP_High_Fast);   
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_5, GPIO_Mode_Out_PP_High_Fast);   
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500F), GPIO_Pin_0, GPIO_Mode_Out_PP_Low_Fast);    
    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500F), GPIO_Pin_2, GPIO_Mode_In_FL_No_IT);        
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500F), GPIO_Pin_3, GPIO_Mode_Out_PP_Low_Fast);    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_0, GPIO_Mode_In_FL_No_IT    );    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_1, GPIO_Mode_Out_PP_Low_Fast);    
    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_5, GPIO_Mode_In_FL_No_IT);        
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_3, GPIO_Mode_Out_PP_High_Fast);
    GPIO_ResetBits(((GPIO_TypeDef *) (uint16_t)0x5005),GPIO_Pin_3);
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_4, GPIO_Mode_Out_PP_High_Fast);
    GPIO_ResetBits(((GPIO_TypeDef *) (uint16_t)0x5005),GPIO_Pin_4);
    
    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_2, GPIO_Mode_Out_PP_High_Fast);    
    ...
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500F), GPIO_Pin_4, GPIO_Mode_In_PU_No_IT);           
    EXTI_SetPinSensitivity(EXTI_Pin_4, EXTI_Trigger_Falling);
    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500F), GPIO_Pin_6, GPIO_Mode_Out_PP_High_Fast);   
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500F), GPIO_Pin_7, GPIO_Mode_Out_PP_High_Fast);   
    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x501E), GPIO_Pin_4, GPIO_Mode_Out_PP_High_Fast);   
    
    
    
    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_1, GPIO_Mode_In_PU_No_IT);           
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_2, GPIO_Mode_Out_PP_Low_Fast);    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_3, GPIO_Mode_Out_PP_Low_Fast);    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_4, GPIO_Mode_In_FL_No_IT);        
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_5, GPIO_Mode_Out_PP_Low_Fast);    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_6, GPIO_Mode_Out_PP_Low_Fast);    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_7, GPIO_Mode_In_FL_No_IT);        
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_6, GPIO_Mode_Out_PP_High_Fast);   
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_7, GPIO_Mode_Out_PP_Low_Fast);    
...
void TIM2_Config(void)
{
    ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR1 |= 0x01; 
    
    ((TIM_TypeDef *) (uint16_t)0x5250)->CR2 = 0x00;
    
    ((TIM_TypeDef *) (uint16_t)0x5250)->PSCR = 0x04;                   
    
    
    ((TIM_TypeDef *) (uint16_t)0x5250)->CR1 |= 0x01;
}
...
void TIM4_Config(void)
{
    ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR1 |= 0x04; 
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->EGR = 0x01;    
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->PSCR = 0x07;                           
    
    
    
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CNTR = 0x01;
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->IER = 0x01;
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 = 0x09;  
}
...
void ADC_Config(void)
{
    ...
    ADC_Init(((ADC_TypeDef *) (uint16_t)0x5340), ADC_ConversionMode_Continuous, ADC_Resolution_12Bit, ADC_Prescaler_2);
    ADC_SamplingTimeConfig(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Group_SlowChannels, ADC_SamplingTime_384Cycles); 
    
    
    ADC_SchmittTriggerConfig(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_0, DISABLE);
    ADC_SchmittTriggerConfig(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_1, DISABLE);
    ADC_SchmittTriggerConfig(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_2, DISABLE);
    ADC_SchmittTriggerConfig(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_3, DISABLE);
    ADC_SchmittTriggerConfig(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_4, DISABLE); 
    
    ADC_DMACmd(((ADC_TypeDef *) (uint16_t)0x5340), ENABLE);							
    ADC_Cmd(((ADC_TypeDef *) (uint16_t)0x5340), ENABLE);
    
     
    ADC_ChannelCmd(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_0, ENABLE);        
    ADC_ChannelCmd(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_1, ENABLE);        
    ADC_ChannelCmd(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_2, ENABLE);        
    ADC_ChannelCmd(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_3, ENABLE);        
    ADC_ChannelCmd(((ADC_TypeDef *) (uint16_t)0x5340), ADC_Channel_4, ENABLE);        
    
    
    
    ADC_SoftwareStartConv(((ADC_TypeDef *) (uint16_t)0x5340));
}
...
void DMA_Config(void)
{
    ...
    DMA_Init(((DMA_Channel_TypeDef *) (uint16_t)0x5075), 
             ((uint16_t)(&ADC_Buffer)),
             ((uint16_t)(&((ADC_TypeDef *) (uint16_t)0x5340)->DRH)),
             ((uint8_t) 0x0B)*((uint8_t) 0x05),
    ...
    DMA_Cmd(((DMA_Channel_TypeDef *) (uint16_t)0x5075), ENABLE);                                             
    DMA_ITConfig(((DMA_Channel_TypeDef *) (uint16_t)0x5075), DMA_ITx_TC, ENABLE);                            
...
void SPI1_Config(void)
{
    ...
    SPI_DeInit(((SPI_TypeDef *) (uint16_t)0x5200));
    SPI_Init(((SPI_TypeDef *) (uint16_t)0x5200),SPI_FirstBit_LSB, 
    ...
    SPI_ITConfig(((SPI_TypeDef *) (uint16_t)0x5200),SPI_IT_RXNE, ENABLE);
    SPI_NSSInternalSoftwareCmd(((SPI_TypeDef *) (uint16_t)0x5200),DISABLE);
    
    __disable_interrupt();    
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_5, GPIO_Mode_In_FL_IT);
    GPIO_Init(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_7, GPIO_Mode_Out_PP_Low_Fast);
