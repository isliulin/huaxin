...
void CLK_DeInit(void)
{
  ((CLK_TypeDef *) (uint16_t)0x50C0)->ICKCR = ((uint8_t)0x11);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->ECKCR = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CRTCR = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CBEEPR = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->SWR  = ((uint8_t)0x01);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->SWCR = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CKDIVR = ((uint8_t)0x03);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR1 = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR2 = ((uint8_t)0x80);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR3 = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CSSR  = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CCOR = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->HSITRIMR = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->HSICALR = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->HSIUNLCKR = ((uint8_t)0x00);
  ((CLK_TypeDef *) (uint16_t)0x50C0)->REGCSR = ((uint8_t)0xB9);
}
...
void CLK_HSICmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((CLK_TypeDef *) (uint16_t)0x50C0)->ICKCR |= ((uint8_t)0x01);
  }
  else
  {
     
    ((CLK_TypeDef *) (uint16_t)0x50C0)->ICKCR &= (uint8_t)(~((uint8_t)0x01));
  }
}
...
void CLK_AdjustHSICalibrationValue(uint8_t CLK_HSICalibrationValue)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->HSIUNLCKR = 0xAC;
  ((CLK_TypeDef *) (uint16_t)0x50C0)->HSIUNLCKR = 0x35;

   
  ((CLK_TypeDef *) (uint16_t)0x50C0)->HSITRIMR = (uint8_t)CLK_HSICalibrationValue;
}
...
void CLK_LSICmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((CLK_TypeDef *) (uint16_t)0x50C0)->ICKCR |= ((uint8_t)0x04);
  }
  else
  {
     
    ((CLK_TypeDef *) (uint16_t)0x50C0)->ICKCR &= (uint8_t)(~((uint8_t)0x04));
  }
}
...
void CLK_HSEConfig(CLK_HSE_TypeDef CLK_HSE)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->ECKCR &= (uint8_t)~((uint8_t)0x01);

   
  ((CLK_TypeDef *) (uint16_t)0x50C0)->ECKCR &= (uint8_t)~((uint8_t)0x10);

   
  ((CLK_TypeDef *) (uint16_t)0x50C0)->ECKCR |= (uint8_t)CLK_HSE;
}
...
void CLK_LSEConfig(CLK_LSE_TypeDef CLK_LSE)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->ECKCR &= (uint8_t)~((uint8_t)0x04);

   
  ((CLK_TypeDef *) (uint16_t)0x50C0)->ECKCR &= (uint8_t)~((uint8_t)0x20);

   
  ((CLK_TypeDef *) (uint16_t)0x50C0)->ECKCR |= (uint8_t)CLK_LSE;
...
void CLK_ClockSecuritySystemEnable(void)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CSSR |= ((uint8_t)0x01);
}
...
void CLK_ClockSecuritySytemDeglitchCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((CLK_TypeDef *) (uint16_t)0x50C0)->CSSR |= ((uint8_t)0x10);
  }
  else
  {
     
    ((CLK_TypeDef *) (uint16_t)0x50C0)->CSSR &= (uint8_t)(~((uint8_t)0x10));
  }
}
...
void CLK_CCOConfig(CLK_CCOSource_TypeDef CLK_CCOSource, CLK_CCODiv_TypeDef CLK_CCODiv)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CCOR = (uint8_t)((uint8_t)CLK_CCOSource | (uint8_t)CLK_CCODiv);
}
...
void CLK_SYSCLKSourceConfig(CLK_SYSCLKSource_TypeDef CLK_SYSCLKSource)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->SWR = (uint8_t)CLK_SYSCLKSource;
}
...
CLK_SYSCLKSource_TypeDef CLK_GetSYSCLKSource(void)
{
  return ((CLK_SYSCLKSource_TypeDef)(((CLK_TypeDef *) (uint16_t)0x50C0)->SCSR));
}
...
uint32_t CLK_GetClockFreq(void)
{
  ...
  clocksource = (CLK_SYSCLKSource_TypeDef)((CLK_TypeDef *) (uint16_t)0x50C0)->SCSR;

  if ( clocksource == CLK_SYSCLKSource_HSI)
  {
    sourcefrequency = ((uint32_t)16000000);
  }
  else if ( clocksource == CLK_SYSCLKSource_LSI)
  {
    sourcefrequency = ((uint32_t)38000);
  }
  ...
  {
    clockfrequency = ((uint32_t)32768);
  }

   
  tmp = (uint8_t)(((CLK_TypeDef *) (uint16_t)0x50C0)->CKDIVR & ((uint8_t)0x07));
...
void CLK_SYSCLKDivConfig(CLK_SYSCLKDiv_TypeDef CLK_SYSCLKDiv)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CKDIVR = (uint8_t)(CLK_SYSCLKDiv);
}
...
void CLK_SYSCLKSourceSwitchCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((CLK_TypeDef *) (uint16_t)0x50C0)->SWCR |= ((uint8_t)0x02);
  }
  else
  {
     
    ((CLK_TypeDef *) (uint16_t)0x50C0)->SWCR &= (uint8_t)(~((uint8_t)0x02));
  }
}
...
void CLK_RTCClockConfig(CLK_RTCCLKSource_TypeDef CLK_RTCCLKSource, CLK_RTCCLKDiv_TypeDef CLK_RTCCLKDiv)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CRTCR = (uint8_t)((uint8_t)CLK_RTCCLKSource | (uint8_t)CLK_RTCCLKDiv);
}
...
void CLK_BEEPClockConfig(CLK_BEEPCLKSource_TypeDef CLK_BEEPCLKSource)
{
  ...
  ((CLK_TypeDef *) (uint16_t)0x50C0)->CBEEPR = (uint8_t)(CLK_BEEPCLKSource);
...
void CLK_PeripheralClockConfig(CLK_Peripheral_TypeDef CLK_Peripheral, FunctionalState NewState)
{
  ...
  if ( reg == 0x00)
  {
    if (NewState != DISABLE)
    {
      ...
      ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR1 |= (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
    }
    else
    {
       
      ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR1 &= (uint8_t)(~(uint8_t)(((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F))));
    }
  }
  else if (reg == 0x10)
  {
    if (NewState != DISABLE)
    {
      ...
      ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR2 |= (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
    }
    else
    {
       
      ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR2 &= (uint8_t)(~(uint8_t)(((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F))));
    }
  }
  else
  {
    if (NewState != DISABLE)
    {
      ...
      ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR3 |= (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
    }
    else
    {
       
      ((CLK_TypeDef *) (uint16_t)0x50C0)->PCKENR3 &= (uint8_t)(~(uint8_t)(((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F))));
    }
  }
}
...
void CLK_LSEClockSecuritySystemEnable(void)
{
  ...
  ((CSSLSE_TypeDef *) (uint16_t)0x5190)->CSR |= ((uint8_t)0x01);
}
...
void CLK_RTCCLKSwitchOnLSEFailureEnable(void)
{
  ...
  ((CSSLSE_TypeDef *) (uint16_t)0x5190)->CSR |= ((uint8_t)0x02);
}
...
void CLK_HaltConfig(CLK_Halt_TypeDef CLK_Halt, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((CLK_TypeDef *) (uint16_t)0x50C0)->ICKCR |= (uint8_t)(CLK_Halt);
  }
  else
  {
    ((CLK_TypeDef *) (uint16_t)0x50C0)->ICKCR &= (uint8_t)(~CLK_Halt);
...
void CLK_MainRegulatorCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((CLK_TypeDef *) (uint16_t)0x50C0)->REGCSR &= (uint8_t)(~((uint8_t)0x02));
  }
  else
  {
     
    ((CLK_TypeDef *) (uint16_t)0x50C0)->REGCSR |= ((uint8_t)0x02);
  }
}
...
void CLK_ITConfig(CLK_IT_TypeDef CLK_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    if (CLK_IT == CLK_IT_SWIF)
    {
      ...
      ((CLK_TypeDef *) (uint16_t)0x50C0)->SWCR |= ((uint8_t)0x04);
    }
    else if (CLK_IT == CLK_IT_LSECSSF)
    {
       
      ((CSSLSE_TypeDef *) (uint16_t)0x5190)->CSR |= ((uint8_t)0x04);
    }
    else
    {
       
      ((CLK_TypeDef *) (uint16_t)0x50C0)->CSSR |= ((uint8_t)0x04);
    }
  }
  else   
  {
    if (CLK_IT == CLK_IT_SWIF)
      ...
      ((CLK_TypeDef *) (uint16_t)0x50C0)->SWCR  &= (uint8_t)(~((uint8_t)0x04));
    }
    else if (CLK_IT == CLK_IT_LSECSSF)
    {
       
      ((CSSLSE_TypeDef *) (uint16_t)0x5190)->CSR &= (uint8_t)(~((uint8_t)0x04));
    }
    else
    {
       
      ((CLK_TypeDef *) (uint16_t)0x50C0)->CSSR &= (uint8_t)(~((uint8_t)0x04));
    }
  }
}
...
FlagStatus CLK_GetFlagStatus(CLK_FLAG_TypeDef CLK_FLAG)
{
  ...
  if (reg == 0x00)  
  {
    reg = ((CLK_TypeDef *) (uint16_t)0x50C0)->CRTCR;
  }
  else if (reg == 0x10)  
  {
    reg = ((CLK_TypeDef *) (uint16_t)0x50C0)->ICKCR;
  }
  else if (reg == 0x20)  
  {
    reg = ((CLK_TypeDef *) (uint16_t)0x50C0)->CCOR;
  }
  else if (reg == 0x30)  
  {
    reg = ((CLK_TypeDef *) (uint16_t)0x50C0)->ECKCR;
  }
  else if (reg == 0x40)  
  {
    reg = ((CLK_TypeDef *) (uint16_t)0x50C0)->SWCR;
  }
  else if (reg == 0x50)  
  {
    reg = ((CLK_TypeDef *) (uint16_t)0x50C0)->CSSR;
  }
  else if (reg == 0x70)  
  {
    reg = ((CLK_TypeDef *) (uint16_t)0x50C0)->REGCSR;
  }
  else if (reg == 0x80)  
  {
    reg = ((CSSLSE_TypeDef *) (uint16_t)0x5190)->CSR;
  }
  else  
  {
    reg = ((CLK_TypeDef *) (uint16_t)0x50C0)->CBEEPR;
  }
...
void CLK_ClearFlag(void)
{
  ...
  ((CSSLSE_TypeDef *) (uint16_t)0x5190)->CSR &= (uint8_t)(~((uint8_t)0x08));
}
...
ITStatus CLK_GetITStatus(CLK_IT_TypeDef CLK_IT)
{
  ...
  if (CLK_IT == CLK_IT_SWIF)
  {
    ...
    if ((((CLK_TypeDef *) (uint16_t)0x50C0)->SWCR & (uint8_t)CLK_IT) == (uint8_t)0x0C)
    {
      bitstatus = SET;
    }
    else
  ...
  else if (CLK_IT == CLK_IT_LSECSSF)
  {
    ...
    if ((((CSSLSE_TypeDef *) (uint16_t)0x5190)->CSR & (uint8_t)CLK_IT) == (uint8_t)0x0C)
    {
      bitstatus = SET;
    }
    else
  ...
  else  
  {
    ...
    if ((((CLK_TypeDef *) (uint16_t)0x50C0)->CSSR & (uint8_t)CLK_IT) == (uint8_t)0x0C)
    {
      bitstatus = SET;
    }
    else
...
void CLK_ClearITPendingBit(CLK_IT_TypeDef CLK_IT)
{
  ...
  else
  {
    ...
    ((CLK_TypeDef *) (uint16_t)0x50C0)->SWCR &= (uint8_t)(~((uint8_t)0x08));
  }
}
