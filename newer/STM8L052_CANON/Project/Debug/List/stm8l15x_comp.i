...
void COMP_DeInit(void)
{
  ...
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 = (uint8_t) ((uint8_t)0x00);

   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 = (uint8_t) ((uint8_t)0x00);

   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 = (uint8_t) ((uint8_t)0xC0);

   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR4 = (uint8_t) ((uint8_t)0x00);

   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR5 = (uint8_t) ((uint8_t)0x00);
}
               ...
               COMP_OutputSelect_Typedef COMP_OutputSelect, COMP_Speed_TypeDef COMP_Speed)
{
  ...
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 &= (uint8_t) (~((uint8_t)0x38));
   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 |= (uint8_t) COMP_InvertingInput;

   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 &= (uint8_t) (~((uint8_t)0xC0));
   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 |= (uint8_t) COMP_OutputSelect;

   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 &= (uint8_t) (~((uint8_t)0x04));
   
  ((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 |= (uint8_t) COMP_Speed;
}
...
void COMP_VrefintToCOMP1Connect(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 |= ((uint8_t)0x04);
  }
  else
  {
     
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 &= (uint8_t)(~((uint8_t)0x04));
  }
}
...
void COMP_EdgeConfig(COMP_Selection_TypeDef COMP_Selection, COMP_Edge_TypeDef COMP_Edge)
{
  ...
  if (COMP_Selection == COMP_Selection_COMP1)
  {
    ...
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 &= (uint8_t) (~((uint8_t)0x03));

     
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 |= (uint8_t) COMP_Edge;
  }
   
  else
  {
     
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 &= (uint8_t) (~((uint8_t)0x03));

     
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 |= (uint8_t) COMP_Edge;
  }
}
...
COMP_OutputLevel_TypeDef COMP_GetOutputLevel(COMP_Selection_TypeDef COMP_Selection)
{
  ...
  if (COMP_Selection == COMP_Selection_COMP1)
  {
    ...
    if ((((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 & ((uint8_t)0x08)) != (uint8_t) RESET)
    {
  ...
  else
  {
    ...
    if ((((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 & ((uint8_t)0x08)) != (uint8_t) RESET)
    {
...
void COMP_WindowCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 |= (uint8_t) ((uint8_t)0x02);
  }
  else
  {
...
void COMP_VrefintOutputCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR3 |= (uint8_t) ((uint8_t)0x01);
  }
  else
  {
...
void COMP_SchmittTriggerCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 |= (uint8_t) ((uint8_t)0x04);
  }
  else
  {
                        ...
                        FunctionalState NewState)
{
  ...
  switch (COMP_TriggerGroup)
  {
    case COMP_TriggerGroup_InvertingInput:
      ...
      if (NewState != DISABLE)
      {
        ((COMP_TypeDef *) (uint16_t)0x5440)->CSR4 &= (uint8_t) ~COMP_TriggerPin;
      }
      else
      {
        ((COMP_TypeDef *) (uint16_t)0x5440)->CSR4 |= (uint8_t) COMP_TriggerPin;
    ...
    case COMP_TriggerGroup_NonInvertingInput:
      if (NewState != DISABLE)
      {
        ((COMP_TypeDef *) (uint16_t)0x5440)->CSR4 &= (uint8_t) ~((uint8_t)(COMP_TriggerPin << 3));
      }
      else
      {
        ((COMP_TypeDef *) (uint16_t)0x5440)->CSR4 |= (uint8_t) (COMP_TriggerPin << 3);
      }
      break;
    ...
    case COMP_TriggerGroup_VREFINTOutput:
      if (NewState != DISABLE)
      {
        ((COMP_TypeDef *) (uint16_t)0x5440)->CSR5 &= (uint8_t) ~COMP_TriggerPin;
      }
      else
      {
        ((COMP_TypeDef *) (uint16_t)0x5440)->CSR5 |= (uint8_t) COMP_TriggerPin;
    ...
    case COMP_TriggerGroup_DACOutput:
      if (NewState != DISABLE)
      {
        ((COMP_TypeDef *) (uint16_t)0x5440)->CSR5 &= (uint8_t) ~((uint8_t)(COMP_TriggerPin << 3));
      }
      else
      {
        ((COMP_TypeDef *) (uint16_t)0x5440)->CSR5 |= (uint8_t) (COMP_TriggerPin << 3);
      }
      break;
...
void COMP_ITConfig(COMP_Selection_TypeDef COMP_Selection, FunctionalState NewState)
{
  ...
  if (COMP_Selection == COMP_Selection_COMP1)
  {
    if (NewState != DISABLE)
    {
      ...
      ((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 |= (uint8_t) ((uint8_t)0x20);
    }
    else
    {
  ...
  else  
  {
    if (NewState != DISABLE)
    {
      ...
      ((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 |= (uint8_t) ((uint8_t)0x20);
    }
    else
    {
...
FlagStatus COMP_GetFlagStatus(COMP_Selection_TypeDef COMP_Selection)
{
  ...
  if (COMP_Selection == COMP_Selection_COMP1)
  {
    if ((((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 & ((uint8_t)0x10)) != (uint8_t) RESET)
    {
  ...
  {
    if ((((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 & ((uint8_t)0x10)) != (uint8_t) RESET)
    {
...
void COMP_ClearFlag(COMP_Selection_TypeDef COMP_Selection)
{
  ...
  if (COMP_Selection == COMP_Selection_COMP1)
  {
    ...
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 &= (uint8_t) (~((uint8_t)0x10));
  }
  else
  {
     
    ((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 &= (uint8_t) (~((uint8_t)0x10));
  }
}
...
ITStatus COMP_GetITStatus(COMP_Selection_TypeDef COMP_Selection)
{
  ...
  if (COMP_Selection == COMP_Selection_COMP1)
  {
    ...
    itstatus = (uint8_t) (((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 & ((uint8_t)0x10));

     
    itenable = (uint8_t) (((COMP_TypeDef *) (uint16_t)0x5440)->CSR1 & ((uint8_t)0x20));
  ...
  else
  {
    ...
    itstatus = (uint8_t) (((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 & ((uint8_t)0x10));

     
    itenable = (uint8_t) (((COMP_TypeDef *) (uint16_t)0x5440)->CSR2 & ((uint8_t)0x20));
