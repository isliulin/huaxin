...
void ITC_DeInit(void)
{
  ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR1 = ((uint8_t)0xFF);
  ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR2 = ((uint8_t)0xFF);
  ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR3 = ((uint8_t)0xFF);
  ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR4 = ((uint8_t)0xFF);
  ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR5 = ((uint8_t)0xFF);
  ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR6 = ((uint8_t)0xFF);
  ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR7 = ((uint8_t)0xFF);
  ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR8 = ((uint8_t)0xFF);
}
...
uint8_t ITC_GetSoftIntStatus(void)
{
  return ((uint8_t)(ITC_GetCPUCC() & ((uint8_t)0x28)));
}
...
ITC_PriorityLevel_TypeDef ITC_GetSoftwarePriority(IRQn_TypeDef IRQn)
{
  ...
  switch (IRQn)
  {
    ...
    case DMA1_CHANNEL2_3_IRQn:
      Value = (uint8_t)(((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR1 & Mask);  
      break;
    ...
    case EXTIB_G_IRQn:
    case EXTID_H_IRQn:
      Value = (uint8_t)(((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR2 & Mask);  
      break;
    ...
    case EXTI2_IRQn:
    case EXTI3_IRQn:
      Value = (uint8_t)(((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR3 & Mask);  
      break;
    ...
    case EXTI6_IRQn:
    case EXTI7_IRQn:
      Value = (uint8_t)(((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR4 & Mask);  
      break;
    ...
    case TIM2_UPD_OVF_TRG_BRK_USART2_TX_IRQn:
      Value = (uint8_t)(((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR5 & Mask);  
      break;
    ...
    case TIM3_CC_USART3_RX_IRQn:
      Value = (uint8_t)(((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR6 & Mask);  
      break;
    ...
    case USART1_TX_TIM5_UPD_OVF_TRG_BRK_IRQn:
      Value = (uint8_t)(((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR7 & Mask);  
      break;

    case USART1_RX_TIM5_CC_IRQn:
    case I2C1_SPI2_IRQn:
      Value = (uint8_t)(((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR8 & Mask);  
      break;
...
void ITC_SetSoftwarePriority(IRQn_TypeDef IRQn, ITC_PriorityLevel_TypeDef ITC_PriorityLevel)
{
  ...
  switch (IRQn)
  {
    ...
    case DMA1_CHANNEL0_1_IRQn:
    case DMA1_CHANNEL2_3_IRQn:
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR1 &= Mask;
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR1 |= NewPriority;
      break;
    ...
    case EXTIB_G_IRQn:
    case EXTID_H_IRQn:
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR2 &= Mask;
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR2 |= NewPriority;
      break;
    ...
    case EXTI2_IRQn:
    case EXTI3_IRQn:
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR3 &= Mask;
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR3 |= NewPriority;
      break;
    ...
    case EXTI6_IRQn:
    case EXTI7_IRQn:
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR4 &= Mask;
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR4 |= NewPriority;
      break;
    case SWITCH_CSS_BREAK_DAC_IRQn:
    case ADC1_COMP_IRQn:
    case LCD_AES_IRQn:
    case TIM2_UPD_OVF_TRG_BRK_USART2_TX_IRQn:
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR5 &= Mask;
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR5 |= NewPriority;
      break;
    case TIM1_UPD_OVF_TRG_IRQn:
    case TIM2_CC_USART2_RX_IRQn:
    case TIM3_UPD_OVF_TRG_BRK_USART3_TX_IRQn :
    case TIM3_CC_USART3_RX_IRQn:
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR6 &= Mask;
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR6 |= NewPriority;
      break;
    ...
    case SPI1_IRQn:
    case USART1_TX_TIM5_UPD_OVF_TRG_BRK_IRQn:
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR7 &= Mask;
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR7 |= NewPriority;
      break;

    case USART1_RX_TIM5_CC_IRQn:
    case I2C1_SPI2_IRQn:
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR8 &= Mask;
      ((ITC_TypeDef *) (uint16_t)0x7F70)->ISPR8 |= NewPriority;
      break;
