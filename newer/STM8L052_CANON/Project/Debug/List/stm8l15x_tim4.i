...
void TIM4_DeInit(void)
{
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1   = ((uint8_t)0x00);
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR2   = ((uint8_t)0x00);
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->SMCR   = ((uint8_t)0x00);
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->IER   = ((uint8_t)0x00);
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->CNTR   = ((uint8_t)0x00);
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->PSCR  = ((uint8_t)0x00);
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->ARR   = ((uint8_t)0xFF);
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->SR1   = ((uint8_t)0x00);
}
                       ...
                       uint8_t TIM4_Period)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->ARR = (uint8_t)(TIM4_Period);
   
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->PSCR = (uint8_t)(TIM4_Prescaler);

   
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->EGR = TIM4_EventSource_Update;
}
                          ...
                          TIM4_PSCReloadMode_TypeDef TIM4_PSCReloadMode)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->PSCR = (uint8_t) Prescaler;

   
  if (TIM4_PSCReloadMode == TIM4_PSCReloadMode_Immediate)
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->EGR |= ((uint8_t)0x01) ;
  }
  else
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->EGR &= (uint8_t)(~((uint8_t)0x01)) ;
  }
}
...
void TIM4_SetCounter(uint8_t Counter)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->CNTR = (uint8_t)(Counter);
}
...
void TIM4_SetAutoreload(uint8_t Autoreload)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->ARR = (uint8_t)(Autoreload);
}
...
{
  uint8_t tmpcntr = 0;
  tmpcntr = ((TIM4_TypeDef *) (uint16_t)0x52E0)->CNTR;
...
TIM4_Prescaler_TypeDef TIM4_GetPrescaler(void)
{
  ...
  return ((TIM4_Prescaler_TypeDef)((TIM4_TypeDef *) (uint16_t)0x52E0)->PSCR);
}
...
void TIM4_UpdateDisableConfig(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 |= ((uint8_t)0x02) ;
  }
  else
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 &= (uint8_t)(~((uint8_t)0x02)) ;
  }
}
...
void TIM4_UpdateRequestConfig(TIM4_UpdateSource_TypeDef TIM4_UpdateSource)
{
  ...
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 |= ((uint8_t)0x04) ;
  }
  else
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 &= (uint8_t)(~((uint8_t)0x04)) ;
  }
}
...
void TIM4_ARRPreloadConfig(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 |= ((uint8_t)0x80) ;
  }
  else
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 &= (uint8_t)(~((uint8_t)0x80)) ;
  }
}
...
void TIM4_SelectOnePulseMode(TIM4_OPMode_TypeDef TIM4_OPMode)
{
  ...
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 |= ((uint8_t)0x08) ;
  }
  else
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 &= (uint8_t)(~((uint8_t)0x08)) ;
  }
}
...
void TIM4_Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 |= ((uint8_t)0x01) ;
  }
  else
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 &= (uint8_t)(~((uint8_t)0x01)) ;
  }
}
...
void TIM4_ITConfig(TIM4_IT_TypeDef TIM4_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->IER |= (uint8_t)TIM4_IT;
  }
  else
  {
     
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->IER &= (uint8_t)(~(uint8_t)TIM4_IT);
  }
}
...
void TIM4_GenerateEvent(TIM4_EventSource_TypeDef TIM4_EventSource)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->EGR |= (uint8_t)TIM4_EventSource;
}
...
FlagStatus TIM4_GetFlagStatus(TIM4_FLAG_TypeDef TIM4_FLAG)
{
  ...
  if ((((TIM4_TypeDef *) (uint16_t)0x52E0)->SR1 & (uint8_t)TIM4_FLAG)  != 0)
  {
    bitstatus = SET;
  }
  else
...
void TIM4_ClearFlag(TIM4_FLAG_TypeDef TIM4_FLAG)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->SR1 = (uint8_t)(~((uint8_t)TIM4_FLAG));
}
...
ITStatus TIM4_GetITStatus(TIM4_IT_TypeDef TIM4_IT)
{
  ...
  itStatus = (uint8_t)(((TIM4_TypeDef *) (uint16_t)0x52E0)->SR1 & (uint8_t)TIM4_IT);

  itEnable = (uint8_t)(((TIM4_TypeDef *) (uint16_t)0x52E0)->IER & (uint8_t)TIM4_IT);
...
void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->SR1 = (uint8_t)(~(uint8_t)TIM4_IT);
}
...
void TIM4_DMACmd( TIM4_DMASource_TypeDef TIM4_DMASource, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->DER |= (uint8_t)TIM4_DMASource;
  }
  else
  {
...
void TIM4_InternalClockConfig(void)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->SMCR &=  (uint8_t)(~((uint8_t)0x07));
}
...
void TIM4_SelectInputTrigger(TIM4_TRGSelection_TypeDef TIM4_InputTriggerSource)
{
  ...
  tmpsmcr = ((TIM4_TypeDef *) (uint16_t)0x52E0)->SMCR;

   
  tmpsmcr &= (uint8_t)(~((uint8_t)0x70));
  tmpsmcr |= (uint8_t)TIM4_InputTriggerSource;

  ((TIM4_TypeDef *) (uint16_t)0x52E0)->SMCR = (uint8_t)tmpsmcr;
}
...
void TIM4_SelectOutputTrigger(TIM4_TRGOSource_TypeDef TIM4_TRGOSource)
{
  ...
  tmpcr2 = ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR2;
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR2 = tmpcr2;
}
...
void TIM4_SelectSlaveMode(TIM4_SlaveMode_TypeDef TIM4_SlaveMode)
{
  ...
  ((TIM4_TypeDef *) (uint16_t)0x52E0)->SMCR = tmpsmcr;
}
...
void TIM4_SelectMasterSlaveMode(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->SMCR |= ((uint8_t)0x80);
  }
  else
  {
    ((TIM4_TypeDef *) (uint16_t)0x52E0)->SMCR &= (uint8_t)(~((uint8_t)0x80));
  }
}
