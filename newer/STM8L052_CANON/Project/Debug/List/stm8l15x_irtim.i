...
void IRTIM_DeInit(void)
{
  ((IRTIM_TypeDef *) (uint16_t)0x52FF)->CR = ((uint8_t)0x00);
}
...
void IRTIM_Cmd(FunctionalState NewState)
{
  ...
  if (NewState ==   DISABLE)
  {
    ((IRTIM_TypeDef *) (uint16_t)0x52FF)->CR &= (uint8_t)(~((uint8_t)0x01)) ;
  }
  else
  {
    ((IRTIM_TypeDef *) (uint16_t)0x52FF)->CR |= ((uint8_t)0x01) ;
  }
}
...
void IRTIM_HighSinkODCmd(FunctionalState NewState)
{
  ...
  if (NewState == DISABLE)
  {
    ((IRTIM_TypeDef *) (uint16_t)0x52FF)->CR &= (uint8_t)(~((uint8_t)0x02)) ;
  }
  else
  {
    ((IRTIM_TypeDef *) (uint16_t)0x52FF)->CR |= ((uint8_t)0x02) ;
  }
}
...
FunctionalState IRTIM_GetStatus(void)
{
  return ((FunctionalState) (((IRTIM_TypeDef *) (uint16_t)0x52FF)->CR & ((uint8_t)0x01)));
}
...
FunctionalState IRTIM_GetHighSinkODStatus(void)
{
  return ((FunctionalState)(((IRTIM_TypeDef *) (uint16_t)0x52FF)->CR & ((uint8_t)0x02)));
}
