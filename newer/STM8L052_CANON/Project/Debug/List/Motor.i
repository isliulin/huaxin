...
const _Motor_Value_TypeDef Motor_Value_Data[35]= {
    Transfer_Motor_24,Transfer_Motor_25,Transfer_Motor_26,     Transfer_Motor_28,Transfer_Motor_30,Transfer_Motor_32,     Transfer_Motor_34,Transfer_Motor_35,Transfer_Motor_38,     Transfer_Motor_40,Transfer_Motor_42,Transfer_Motor_45,     Transfer_Motor_48,Transfer_Motor_50,Transfer_Motor_52,     Transfer_Motor_55,Transfer_Motor_58,Transfer_Motor_62,     Transfer_Motor_66,Transfer_Motor_70,Transfer_Motor_75,     Transfer_Motor_80,Transfer_Motor_85,Transfer_Motor_90,     Transfer_Motor_92,Transfer_Motor_95,Transfer_Motor_98,     Transfer_Motor_105,Transfer_Motor_112,Transfer_Motor_120,     Transfer_Motor_130,Transfer_Motor_135,Transfer_Motor_140,     Transfer_Motor_180,Transfer_Motor_200
};

const _Motor_Step_TypeDef Motor_Step_Data[35] = {
    Motor_Step_24,Motor_Step_25,Motor_Step_26,     Motor_Step_28,Motor_Step_30,Motor_Step_32,     Motor_Step_33,Motor_Step_34,Motor_Step_38,     Motor_Step_40,Motor_Step_42,Motor_Step_45,     Motor_Step_48,Motor_Step_50,Motor_Step_52,     Motor_Step_55,Motor_Step_58,Motor_Step_62,     Motor_Step_66,Motor_Step_70,Motor_Step_75,     Motor_Step_80,Motor_Step_85,Motor_Step_90,     Motor_Step_92,Motor_Step_95,Motor_Step_98,     Motor_Step_105,Motor_Step_112,Motor_Step_120,     Motor_Step_130,Motor_Step_135,Motor_Step_140,     Motor_Step_180,Motor_Step_200
};
...
void Motor_Contorl(void)
{
    ...
    {      
        ...
        {                                         
          case Motor_Normal_Run:
            {
                ...
                {
                    for(Motor_Count = 0; Motor_Count < 35; Motor_Count++)
                    {
                ...
                {                       
                    if(Motor_Manger_TypeDef.fMotor_State.fMotor_Reset == SET)
                    {
                        ...
                        {                             
                            Motor_Manger_TypeDef.Motor_Step =                                 Motor_Step_Data[Motor_Count] - Motor_Step_Data[Motor_Manger_TypeDef.Motor_Mem];                            
                            Motor_Manger_TypeDef.Motor_Mem  = Motor_Count;
                        }
                    }
                    else
                    {
                        {Motor_Manger_TypeDef . Motor_State = Motor_Reset_Check;};
                    }
                }              
            }break;
          ...
          case Motor_Reset_Check:
            {
                if(!GPIO_ReadInputDataBit(((GPIO_TypeDef *) (uint16_t)0x501E), GPIO_Pin_3))
                {
          ...
          case Motor_Reset_Forward:
            {
                Motor_Manger_TypeDef.Motor_Step = (signed int)210;
          ...
          case Motor_Reset_Reverse:
            {
                Motor_Manger_TypeDef.Motor_Step = 0 - (signed int)210;


            }break; 
          case Motor_Reset_Error:
            {
                ((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_1);;
            }
        }       
    }
    ...
    {  
        ...
        {
            if(uwTick - Motor_Manger_TypeDef.Motor_tickstart > 3000)
            {
...
void Moto_Operation(void)
{
    if(Motor_Manger_TypeDef.Motor_Step > 0)
    {
        ((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_1;;
        Motor_Manger_TypeDef.Motor_Move_State = Motor_Move_In;
        ((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= 0xFA;;
        switch(Motor_Manger_TypeDef.Motor_Period)
        {          
          case Motor_Forward_1s4: {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_0);;((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_2;;};break;
          case Motor_Forward_2s4: {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_0;; ((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_2;;};break; 
          case Motor_Forward_3s4: {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_0;; ((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_2);;};break;
          case Motor_Forward_4s4: {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_0);;((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_2);;};break;        
        }
        if(++Motor_Manger_TypeDef.Motor_Period > Motor_Forward_4s4)
        {
            ...
            if(Motor_Manger_TypeDef.Motor_State == Motor_Reset_Forward)
            {
                if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) (uint16_t)0x501E), GPIO_Pin_3))
                {
                    {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_1);; Motor_Manger_TypeDef . Motor_Step = 0; Motor_Manger_TypeDef . Motor_Mem = 0xFF; Motor_Manger_TypeDef . Motor_State = Motor_Normal_Run;};
                }
            }                                        
        }
    }
    else if(Motor_Manger_TypeDef.Motor_Step < 0)
    {
        ...
        switch(Motor_Manger_TypeDef.Motor_Period)
        {
          case Motor_Reverse_1s4: {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_0;; ((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_2);;};break;
          case Motor_Reverse_2s4: {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_0;; ((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_2;;};break;
          case Motor_Reverse_3s4: {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_0);;((GPIO_TypeDef *) (uint16_t)0x5014)->ODR |= GPIO_Pin_2;;};break;
          case Motor_Reverse_4s4: {((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_0);;((GPIO_TypeDef *) (uint16_t)0x5014)->ODR &= (uint8_t)(~GPIO_Pin_2);;};break;
        }
