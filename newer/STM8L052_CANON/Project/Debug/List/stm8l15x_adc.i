...
void ADC_DeInit(ADC_TypeDef* ADCx)
{
  ...
  ADCx->CR1 =  ((uint8_t) 0x00);
  ADCx->CR2 =  ((uint8_t) 0x00);
  ADCx->CR3 =  ((uint8_t) 0x1F);

   
  ADCx->SR =  (uint8_t)~((uint8_t) 0x00);

   
  ADCx->HTRH =  ((uint8_t) 0x0F);
  ADCx->HTRL =  ((uint8_t) 0xFF);

   
  ADCx->LTRH =  ((uint8_t) 0x00);
  ADCx->LTRL =  ((uint8_t) 0x00);

   
  ADCx->SQR[0] =  ((uint8_t) 0x00);
  ADCx->SQR[1] =  ((uint8_t) 0x00);
  ADCx->SQR[2] =  ((uint8_t) 0x00);
  ADCx->SQR[3] =  ((uint8_t) 0x00);

   
  ADCx->TRIGR[0] =  ((uint8_t) 0x00);
  ADCx->TRIGR[1] =  ((uint8_t) 0x00);
  ADCx->TRIGR[2] =  ((uint8_t) 0x00);
  ADCx->TRIGR[3] =  ((uint8_t) 0x00);
}
              ...
              ADC_Prescaler_TypeDef ADC_Prescaler)
{
  ...
  ADCx->CR1 &= (uint8_t)~(((uint8_t)0x04) | ((uint8_t)0x60));

   
  ADCx->CR1 |= (uint8_t)((uint8_t)ADC_ConversionMode | (uint8_t)ADC_Resolution);

   
  ADCx->CR2 &= (uint8_t)~(((uint8_t)0x80));
             ...
             FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ADCx->CR1 |= ((uint8_t)0x01);
  }
  else
  {
     
    ADCx->CR1 &= (uint8_t)~((uint8_t)0x01);
  }
}
                            ...
                            ADC_ExtTRGSensitivity_TypeDef ADC_ExtTRGSensitivity)
{
  ...
  ADCx->CR2 &= (uint8_t)~(((uint8_t)0x60) | ((uint8_t)0x18));
...
void ADC_TempSensorCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ADC_TypeDef *) (uint16_t)0x5340)->TRIGR[0] |= (uint8_t)(((uint8_t)0x20));
  }
  else
  {
...
void ADC_VrefintCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ADC_TypeDef *) (uint16_t)0x5340)->TRIGR[0] |= (uint8_t)(((uint8_t)0x10));
  }
  else
  {
                            ...
                            ADC_SamplingTime_TypeDef ADC_SamplingTime)
{
  ...
  if ( ADC_GroupChannels != ADC_Group_SlowChannels)
  {
    ...
    ADCx->CR3 &= (uint8_t)~((uint8_t)0xE0);
    ADCx->CR3 |= (uint8_t)(ADC_SamplingTime << 5);
  }
  else
  {
     
    ADCx->CR2 &= (uint8_t)~((uint8_t)0x07);
...
void ADC_DMACmd(ADC_TypeDef* ADCx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ADCx->SQR[0] &= (uint8_t)~((uint8_t)0x80);
  }
  else
  {
     
    ADCx->SQR[0] |= ((uint8_t)0x80);
  }
}
