...
void PWR_DeInit(void)
{
  ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 = ((uint8_t)0x20);
  ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR2 = ((uint8_t)0x00);
}
...
void PWR_PVDLevelConfig(PWR_PVDLevel_TypeDef PWR_PVDLevel)
{
  ...
  ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 &= (uint8_t)(~((uint8_t)0x0E));

   
  ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 |= PWR_PVDLevel;
...
void PWR_PVDCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 |= ((uint8_t)0x01);
  }
  else
  {
     
    ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 &= (uint8_t)(~((uint8_t)0x01));
  }
}
...
void PWR_FastWakeUpCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR2 |= ((uint8_t)0x04);
  }
  else
  {
     
    ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR2 &= (uint8_t)(~((uint8_t)0x04));
  }
}
...
void PWR_UltraLowPowerCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR2 |= ((uint8_t)0x02);
  }
  else
  {
     
    ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR2 &= (uint8_t)(~((uint8_t)0x02));
  }
}
...
void PWR_PVDITConfig(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 |= ((uint8_t)0x10);
  }
  else
  {
     
    ((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 &= (uint8_t)(~((uint8_t)0x10));
  }
}
...
FlagStatus PWR_GetFlagStatus(PWR_FLAG_TypeDef PWR_FLAG)
{
  ...
  {
    if ((((PWR_TypeDef *) (uint16_t)0x50B2)->CSR2 & ((uint8_t)0x01)) != (uint8_t)RESET )
    {
      bitstatus = SET;
    }
    else
  ...
  {
    if ((((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 & PWR_FLAG) != (uint8_t)RESET )
    {
      bitstatus = SET;
    }
    else
...
ITStatus PWR_PVDGetITStatus(void)
{
  ...
  PVD_itStatus = (uint8_t)(((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 & (uint8_t)((uint8_t)0x20));
  PVD_itEnable = (uint8_t)(((PWR_TypeDef *) (uint16_t)0x50B2)->CSR1 & (uint8_t)((uint8_t)0x10));
