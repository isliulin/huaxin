...
void Task_1(void)
{
   static uint8_t  IGBT_30V_EN_Flag;
    ...
    if(SysInfo.frash_Start_Flag == 0)
    {
        ...
        {
          case 4:GPIO_SetBits(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_6) ;break;
          case 8:GPIO_ResetBits(((GPIO_TypeDef *) (uint16_t)0x5014), GPIO_Pin_6);IGBT_30V_EN_Flag = 0;break;
          default:break;
        }
    }
}
...
{   
    ...
    if(SysInfo.Sys_Power_Flag_On)                                
    {
        SysInfo.Sys_Power_Flag_On = 0;  
        GPIO_SetBits(((GPIO_TypeDef *) (uint16_t)0x5005),GPIO_Pin_1);
        SysInfo.KEY_SET_Change_flag = SET;
    }
    if(SysInfo.Sys_Power_Flag_Off)
    {
        SysInfo.Sys_Power_Flag_Off = 0; 
        GPIO_ResetBits(((GPIO_TypeDef *) (uint16_t)0x5005),GPIO_Pin_1);
    }
    
    if(SysInfo.Sys_Sleep_Count > 3600)  
    {
        Save_EepromData();        
        SysInfo.Sys_Power_Flag_Off = 1;
    }
    
    if((SysInfo.BK_Light_Flag)&(SysInfo.BK_Light_Count<40))     
    {
        GPIO_SetBits(((GPIO_TypeDef *) (uint16_t)0x500F),GPIO_Pin_3);
    }
    else
    {
        SysInfo.BK_Light_Flag = 0;
        SysInfo.BK_Light_Count = 0;
        GPIO_ResetBits(((GPIO_TypeDef *) (uint16_t)0x500F),GPIO_Pin_3);
    }   
}
void Task_3(void)
{
...
void Task_4(void)
{
    ...
    {
        {GPIO_SetBits(((GPIO_TypeDef *) (uint16_t)0x500F),GPIO_Pin_6);GPIO_SetBits(((GPIO_TypeDef *) (uint16_t)0x500F),GPIO_Pin_7);};
    }
}
void Task_5(void)
{   
...
void ComMonitor(void)
{
    ...
    if(ADC_VALUE.Channel_AF_VALUE > 3000)
    {
        GPIO_SetBits(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_5);
    }
    else
    {
