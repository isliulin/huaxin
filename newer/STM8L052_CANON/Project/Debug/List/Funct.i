...
void GPIO_Pin_1_Callback(void)
{
    switch(Sys_Mode_Typedef)
    {
      case Sys_Mode_S1:
        {
            uint32_t delay_time;
            ((GPIO_TypeDef *) (uint16_t)0x500A)->CR2 &= (uint8_t)(~(GPIO_Pin_1));
            
            Formalfrash(Flash_Time_Group[getVolLevel()][(Flash_Output_Typedef+9)+6]);
            delay_time = 0x1000;
            while(delay_time--);
            ((GPIO_TypeDef *) (uint16_t)0x500A)->CR2 |= GPIO_Pin_1;            
        }break;
      case Sys_Mode_S2:
        {
            ((GPIO_TypeDef *) (uint16_t)0x500A)->CR2 &= (uint8_t)(~(GPIO_Pin_1));
...
void Canon_Link_Camera(void)      
{
    ...
    *multiSet.eTimes    = Multi_Times_TypeDef;
    ...
    {
      case  M_Zoom_AUTO :*motoSet.mode = 0x00;motoSet.destRsv = 0;menuPara.motoCod = 0x01 ;break;
      case  M_Zoom_24mm :*motoSet.mode = 0x01;motoSet.destRsv = 24;menuPara.motoCod = 0x11 ;motoSet.focIndex=1;break;
      case  M_Zoom_28mm :*motoSet.mode = 0x01;motoSet.destRsv = 28;menuPara.motoCod = 0x12 ;motoSet.focIndex=2;break;
      case  M_Zoom_35mm :*motoSet.mode = 0x01;motoSet.destRsv = 35;menuPara.motoCod = 0x13 ;motoSet.focIndex=3;break;
      case  M_Zoom_50mm :*motoSet.mode = 0x01;motoSet.destRsv = 50;menuPara.motoCod = 0x14 ;motoSet.focIndex=4;break;
      case  M_Zoom_70mm :*motoSet.mode = 0x01;motoSet.destRsv = 70;menuPara.motoCod = 0x15 ;motoSet.focIndex=5;break;
      case  M_Zoom_80mm :*motoSet.mode = 0x01;motoSet.destRsv = 80;menuPara.motoCod = 0x16 ;motoSet.focIndex=6;break;
      case  M_Zoom_105mm:*motoSet.mode = 0x01;motoSet.destRsv = 105;menuPara.motoCod = 0x17; motoSet.focIndex=7;break;
      case  M_Zoom_135mm:*motoSet.mode = 0x01;motoSet.destRsv = 135;menuPara.motoCod = 0x17; motoSet.focIndex=8;break;
      case  M_Zoom_180mm:*motoSet.mode = 0x01;motoSet.destRsv = 180;menuPara.motoCod = 0x17; motoSet.focIndex=9;break;
