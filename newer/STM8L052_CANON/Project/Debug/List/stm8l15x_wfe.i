...
void WFE_DeInit(void)
{
  ((WFE_TypeDef *) (uint16_t)0x50A6)->CR1 = ((uint8_t)0x00);
  ((WFE_TypeDef *) (uint16_t)0x50A6)->CR2 = ((uint8_t)0x00);
  ((WFE_TypeDef *) (uint16_t)0x50A6)->CR3 = ((uint8_t)0x00);
  ((WFE_TypeDef *) (uint16_t)0x50A6)->CR4 = ((uint8_t)0x00);
}
...
void WFE_WakeUpSourceEventCmd(WFE_Source_TypeDef WFE_Source, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    {
      case 1:
        ((WFE_TypeDef *) (uint16_t)0x50A6)->CR1 |= (uint8_t)WFE_Source;
        break;

      case 2:
        ((WFE_TypeDef *) (uint16_t)0x50A6)->CR2 |= (uint8_t)WFE_Source;
        break;

      case 3:
        ((WFE_TypeDef *) (uint16_t)0x50A6)->CR3 |= (uint8_t)WFE_Source;
        break;

      case 4:
        ((WFE_TypeDef *) (uint16_t)0x50A6)->CR4 |= (uint8_t)WFE_Source;
        break;
  ...
  else
  {
    ...
    {
      case 1:
        ((WFE_TypeDef *) (uint16_t)0x50A6)->CR1 &= (uint8_t)(~(uint8_t)WFE_Source);
        break;

      case 2:
        ((WFE_TypeDef *) (uint16_t)0x50A6)->CR2 &= (uint8_t)(~ (uint8_t)WFE_Source);
        break;

      case 3:
        ((WFE_TypeDef *) (uint16_t)0x50A6)->CR3 &= (uint8_t)(~(uint8_t)WFE_Source);
        break;

      case 4:
        ((WFE_TypeDef *) (uint16_t)0x50A6)->CR4 &= (uint8_t)(~(uint8_t)WFE_Source);
        break;
...
FunctionalState WFE_GetWakeUpSourceEventStatus(WFE_Source_TypeDef WFE_Source)
{
  ...
  switch (WFE_Source)
  {
    ...
    case WFE_Source_EXTI_EV3:
      ...
      if ((((WFE_TypeDef *) (uint16_t)0x50A6)->CR1 & (uint8_t)WFE_Source) != (uint8_t)0x00)
      {
    ...
    case WFE_Source_ADC1_COMP_EV:
      ...
      if ((((WFE_TypeDef *) (uint16_t)0x50A6)->CR2 & (uint8_t)WFE_Source) != (uint8_t)0x00)
      {
    ...
    case WFE_Source_DMA1CH23_EV:
      ...
      if ((((WFE_TypeDef *) (uint16_t)0x50A6)->CR3 & (uint8_t)WFE_Source) != (uint8_t)0x00)
      {
    ...
    case WFE_Source_RTC_CSS_EV:
      ...
      if ((((WFE_TypeDef *) (uint16_t)0x50A6)->CR4 & (uint8_t)WFE_Source) != (uint8_t)0x00)
      {
