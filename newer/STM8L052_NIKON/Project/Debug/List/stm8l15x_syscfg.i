...
void SYSCFG_RIDeInit(void)
{
  ((RI_TypeDef *) (uint16_t)0x5430)->ICR1   = ((uint8_t)0x00);      
  ((RI_TypeDef *) (uint16_t)0x5430)->ICR2   = ((uint8_t)0x00);      
  ((RI_TypeDef *) (uint16_t)0x5430)->IOSR1  = ((uint8_t)0x00);     
  ((RI_TypeDef *) (uint16_t)0x5430)->IOSR2  = ((uint8_t)0x00);     
  ((RI_TypeDef *) (uint16_t)0x5430)->IOSR3  = ((uint8_t)0x00);     
  ((RI_TypeDef *) (uint16_t)0x5430)->IOSR4  = ((uint8_t)0x00);     
  ((RI_TypeDef *) (uint16_t)0x5430)->ASCR1  = ((uint8_t)0x00);     
  ((RI_TypeDef *) (uint16_t)0x5430)->ASCR2  = ((uint8_t)0x00);     
  ((RI_TypeDef *) (uint16_t)0x5430)->RCR    = ((uint8_t)0x00);       
}
                                    ...
                                    RI_InputCaptureRouting_TypeDef RI_InputCaptureRouting)
{
  ...
  if (RI_InputCapture == RI_InputCapture_IC2)
  {
    ...
    ((RI_TypeDef *) (uint16_t)0x5430)->ICR1 = (uint8_t) RI_InputCaptureRouting;
  }

  else  
  {
     
    ((RI_TypeDef *) (uint16_t)0x5430)->ICR2 = (uint8_t) RI_InputCaptureRouting;
  }
}
                                 ...
                                 FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    if (AnalogSwitchRegister == (uint8_t) 0x10)
    {
      ...
      ((RI_TypeDef *) (uint16_t)0x5430)->ASCR1 |= (uint8_t) ((uint8_t)1 << (uint8_t) AnalogSwitchIndex);
    }
    else
    {
       
      ((RI_TypeDef *) (uint16_t)0x5430)->ASCR2 |= (uint8_t) ((uint8_t)1 << (uint8_t) AnalogSwitchIndex);
    }
  }
  else
  {
    if (AnalogSwitchRegister == (uint8_t) 0x10)
    {
      ...
      ((RI_TypeDef *) (uint16_t)0x5430)->ASCR1 &= (uint8_t) (~(uint8_t)((uint8_t)1 <<  AnalogSwitchIndex));
    }
    else
    {
       
      ((RI_TypeDef *) (uint16_t)0x5430)->ASCR2 &= (uint8_t) (~ (uint8_t)((uint8_t)1 << AnalogSwitchIndex));
    }
  }
}
                             ...
                             FunctionalState NewState)
{
  ...
  if (IOSwitchRegister == (uint8_t) 0x10)
  {
    if (NewState != DISABLE)
    {
      ...
      ((RI_TypeDef *) (uint16_t)0x5430)->IOSR1 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
    }
    else
    {
       
      ((RI_TypeDef *) (uint16_t)0x5430)->IOSR1 &= (uint8_t) (~ (uint8_t)((uint8_t)1 << IOSwitchIndex));
    }
  }
  ...
  else if (IOSwitchRegister == (uint8_t) 0x20)
  {
    if (NewState != DISABLE)
    {
      ...
      ((RI_TypeDef *) (uint16_t)0x5430)->IOSR2 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
    }
    else
    {
       
      ((RI_TypeDef *) (uint16_t)0x5430)->IOSR2 &= (uint8_t) (~(uint8_t)((uint8_t)1 <<  IOSwitchIndex));
    }
  }
  ...
  else if (IOSwitchRegister == (uint8_t) 0x30)
  {
    if (NewState != DISABLE)
    {
      ...
      ((RI_TypeDef *) (uint16_t)0x5430)->IOSR3 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
    }
    else
    {
       
      ((RI_TypeDef *) (uint16_t)0x5430)->IOSR3 &= (uint8_t) (~ (uint8_t) ((uint8_t) 1 << IOSwitchIndex));
    }
  }
  ...
  else
  {
    if (NewState != DISABLE)
    {
      ...
      ((RI_TypeDef *) (uint16_t)0x5430)->IOSR4 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
    }
    else
    {
       
      ((RI_TypeDef *) (uint16_t)0x5430)->IOSR4 &= (uint8_t) (~ (uint8_t) ((uint8_t) 1 << IOSwitchIndex));
    }
  }
}
...
void SYSCFG_RIResistorConfig(RI_Resistor_TypeDef RI_Resistor, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((RI_TypeDef *) (uint16_t)0x5430)->RCR |= (uint8_t) RI_Resistor;
  }
  else
  {
...
void SYSCFG_REMAPDeInit(void)
{
  ...
  ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR1 = ((uint8_t)0x0C);

   
  ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR2 = ((uint8_t)0x00);

   
  ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR3 = ((uint8_t)0x00);
}
...
void SYSCFG_REMAPPinConfig(REMAP_Pin_TypeDef REMAP_Pin, FunctionalState NewState)
{
  ...
  if (regindex == 0x01)
  {
    ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR1 &= (uint8_t)((uint8_t)((uint8_t)REMAP_Pin << 4) | (uint8_t)0x0F);
    if (NewState != DISABLE)
    {
      ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR1 |= (uint8_t)((uint16_t)REMAP_Pin & (uint16_t)0x00F0);
    }
  }
  ...
  else if (regindex == 0x02)
  {
    if (NewState != DISABLE)
    {
      ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR2 |= (uint8_t) REMAP_Pin;
    }
    else
    {
      ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR2 &= (uint8_t)((uint16_t)(~(uint16_t)REMAP_Pin));
    }
  }
  ...
  else
  {
    if (NewState != DISABLE)
    {
      ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR3 |= (uint8_t) REMAP_Pin;
    }
    else
    {
      ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR3 &= (uint8_t)((uint16_t)(~(uint16_t)REMAP_Pin));
    }
  }
}
...
void SYSCFG_REMAPDMAChannelConfig(REMAP_DMAChannel_TypeDef REMAP_DMAChannel)
{
  ...
  if ((REMAP_DMAChannel & 0xF0) != RESET)
  {
    ...
    ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR1 &= (uint8_t) (~((uint8_t)0x0C));
  }
   
  else
  {
     
    ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR1 &= (uint8_t) (~((uint8_t)0x03));
  }
   
  ((SYSCFG_TypeDef *) (uint16_t)0x509D)->RMPCR1 |= (uint8_t) ((uint8_t)0x0F & REMAP_DMAChannel);
}
