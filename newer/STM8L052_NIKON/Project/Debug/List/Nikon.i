...
u8 const focLen_code[] ={
    ...
    0x57,0x59,0x5a,0x5c,0x5e,0x60,0x62,0x64,0x65,0x66,0x67,0x6a,0x6c,0x6e,0x71,0x73,0x76,0x7a,0x80, 
};
...
u8 const focLen_val[] = {
    ...
    62,65,66,70,75,80,85,90,92,95,98,105,112,120,130,135,150,170,200, 
};
...
void NikTmComRst(void)
{
    { ((GPIO_TypeDef *) (uint16_t)0x5005)->CR2&=(u8)(GPIO_Pin_4); };
    RstComPara();
...
void SetComRstTime(void)
{
    ...
    { ((TIM4_TypeDef *) (uint16_t)0x52E0)->CNTR = (255 - 250); ((TIM4_TypeDef *) (uint16_t)0x52E0)->CR1 = 0x09; };	
    g_tmHandleFlag |= 0x10;
...
void CmrLinkWatchDog(void)
{
    if(cmrPara.cls>0)
    {
        ...
        if(!(((((GPIO_TypeDef *) (uint16_t)0x5005)->IDR)>>4)&0x01))
        {
            cmrPara.linkTmr++;
            if(cmrPara.linkTmr>200)                     
            {
...
void SetSBOInt(void)
{
    ...
    ((GPIO_TypeDef *) (uint16_t)0x5005)->DDR &= (u8)(~GPIO_Pin_6);
    ((GPIO_TypeDef *) (uint16_t)0x5005)->DDR &= (u8)(~GPIO_Pin_7);
    ...
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 &= 0x3F;
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 |= 0x80;
    ...
    ((GPIO_TypeDef *) (uint16_t)0x5005)->CR2 &= 0xBF;
    ((GPIO_TypeDef *) (uint16_t)0x5005)->CR2 |= 0x80;
...
void InitNssIntPort(void)
{
    ...
    ((GPIO_TypeDef *) (uint16_t)0x5005)->DDR &= (u8)(~GPIO_Pin_4);
    ...
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 &= 0xFC;
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 |= 0x02;
...
void SetNssSleepInt(void)
{
    ...
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 &= 0xFC;
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 |= 0x01;
    
    
    
    ((GPIO_TypeDef *) (uint16_t)0x5005)->CR1 &= (u8)(~GPIO_Pin_4);
    ((GPIO_TypeDef *) (uint16_t)0x5005)->CR2 |= GPIO_Pin_4; 
    asm("rim");
}
...
void SPIn_Init(void) 
{
    ...
    ((GPIO_TypeDef *) (uint16_t)0x5005)->DDR &= 0x6f;       
    ((GPIO_TypeDef *) (uint16_t)0x5005)->DDR |= 0x60;		  
    ...
    ((SPI_TypeDef *) (uint16_t)0x5200)->CR1 |= ( 7 << 3 );
    ((SPI_TypeDef *) (uint16_t)0x5200)->CR1 |= ( 3 << 0 );
    ((SPI_TypeDef *) (uint16_t)0x5200)->CR1 |= ( 1 << 7 );
    
    ((SPI_TypeDef *) (uint16_t)0x5200)->CR2 = 0x03;
    
    ((SPI_TypeDef *) (uint16_t)0x5200)->CR1 |= ( 1 << 2 );
...
void NikComInit(void)
{
    ...
    { {((SPI_TypeDef *) (uint16_t)0x5200)->CR1 &= ~0x40;((GPIO_TypeDef *) (uint16_t)0x5005)->DDR|=GPIO_Pin_5;((GPIO_TypeDef *) (uint16_t)0x5005)->CR1|=GPIO_Pin_5;((GPIO_TypeDef *) (uint16_t)0x5005)->CR2|=GPIO_Pin_5;}; GPIO_WriteBit(((GPIO_TypeDef *) (uint16_t)0x5005),GPIO_Pin_5,SET); };
    asm("sim");
    SetSBOInt();
    asm("rim");
    { InitNssIntPort();};
...
u8 ClkSynRcv(u8* rcvDat)
{
    ...
    ((SPI_TypeDef *) (uint16_t)0x5200)->DR = 0xFF;    
...
u8 ClkSynSend(u8 liteCode)
{
    ...
    {((GPIO_TypeDef *) (uint16_t)0x5005)->DDR|=GPIO_Pin_6;};
    {((GPIO_TypeDef *) (uint16_t)0x5005)->DDR&=(u8)(~GPIO_Pin_7);};
    { ((SPI_TypeDef *) (uint16_t)0x5200)->CR1|=0X40; };
    ...
    g_srMod = 1;
    g_spiBuf = liteCode;
    ((SPI_TypeDef *) (uint16_t)0x5200)->DR = liteCode;
...
void GPIO_Pin_4_Callback(void)
{    
    if(((EXTI_TypeDef *) (uint16_t)0x50A0)->SR1 & 0x10) 
    {		 
        ((EXTI_TypeDef *) (uint16_t)0x50A0)->SR1 |= 0x10; 
        if (!(((((GPIO_TypeDef *) (uint16_t)0x5005)->IDR)>>4)&0x01))
        {           
            if (0x0D == g_nikComStatue)
            {
                ClearComRstTime();
                ComDataHandleProc();
            }
...
else if (0X04 == g_nikComStatue)
        {
            g_sleepTag = SLEEP_TAG_NIK;
            g_nikComStatue = 0x00;
            return;
        }
        if (!(((((GPIO_TypeDef *) (uint16_t)0x500F)->IDR)>>4)&0x01))
        {	
...
void GPIO_Pin_7_Callback(void)
{
    ...
    if(((EXTI_TypeDef *) (uint16_t)0x50A0)->SR1 & 0x80) 
    {		
        ((EXTI_TypeDef *) (uint16_t)0x50A0)->SR1 |= 0x80; 
...
{
    if (((SPI_TypeDef *) (uint16_t)0x5200)->SR & 0x02)             
    {
        { ((SPI_TypeDef *) (uint16_t)0x5200)->CR3 = 0x00; };
        SpiSrIntProc();
        
        if (0x00 == g_nikComStatue)
        {
            SetSBOInt();
        }        
    }
...
static void SBOintHandle(void)
{
    switch(g_nikComStatue)
    {
      ...
      case 0x01:                                         
        if ((!(((((GPIO_TypeDef *) (uint16_t)0x5005)->IDR)>>7)&0x01))&&((((((GPIO_TypeDef *) (uint16_t)0x5005)->IDR)>>4)&0x01)>0))
        {
            if ( g_isComStop > 0 )
            {
                g_isComStop = 0;
            ...
            {
                g_nikComStatue = 0x0D;
                {{((SPI_TypeDef *) (uint16_t)0x5200)->CR1 &= ~0x40;((GPIO_TypeDef *) (uint16_t)0x5005)->DDR|=GPIO_Pin_6;}; (GPIO_WriteBit(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_6,RESET));};
                { ((GPIO_TypeDef *) (uint16_t)0x5005)->CR2 &= (u8)(~GPIO_Pin_7); };
...
void SetBkLightInfo(u8 isOn)
{
    ...
    {
        macData2[0] |= 0x02;
        macData2[21] = VerCodeCal(macData2);
    }
    else
    {
        macData2[0] &= ~0x02;
...
void GetCmrInfo(unsigned char lead)
{
    ...
    switch(lead)
    {
      ...
      case 0xb0:
        if(cmrPara.pApert!=g_spiRcvData[0x05])
        {
            
            i = CodeSearch((char*)apert_code, sizeof(apert_code), g_spiRcvData[0x05]);
            if(i<sizeof(apert_code))
            {
                
                cmrPara.apert = cmrApertVal[i];
                
                cmrPara.pApert = g_spiRcvData[0x05];
                {g_dspUpdateFlag|=0x0001;};
                
            }
            
        }
        if((cmrPara.pIso!=g_spiRcvData[0x03])
           ||(cmrPara.pIsoBk1!=g_spiRcvData[12])
               ||(cmrPara.pIsoBk2!=g_spiRcvData[13]))
        {
            cmrPara.pIsoBk1 = g_spiRcvData[12];
            cmrPara.pIsoBk2 = g_spiRcvData[13];
            
            
            if(g_spiRcvData[0x03]<=0x72)
            {
                if((g_spiRcvData[0x03]-0x18)&0x01)
                {
                    cmrPara.pIso = g_spiRcvData[0x03];
            ...
            if((g_spiRcvData[0x03]==g_spiRcvData[12])
               &&(g_spiRcvData[0x03]==g_spiRcvData[13]))
            {
                cmrPara.isAutoIso = 0;
        ...
        if(cmrPara.pShutter!=g_spiRcvData[0x04])
        {
            cmrPara.pShutter = g_spiRcvData[0x04];
        ...
        if(cmrPara.pFocLen!=g_spiRcvData[0x06])
        {
            
            i = CodeSearch((char*)focLen_code, sizeof(focLen_code), g_spiRcvData[0x06]);
            if(i<sizeof(focLen_code))
            {
                cmrPara.pFocLen = g_spiRcvData[0x06];
                cmrPara.focLen = focLen_val[i];
                
                if(*motoSet.mode==0x00)
                {
        ...
        if(cmrPara.mode!=g_spiRcvData[0x01])
        {
            cmrPara.mode = g_spiRcvData[0x01];
            cmrPara.rearCurtain = 1;
            CmrLedCtrl();
            {g_dspUpdateFlag|=0x0001;};
        }
        
        if(cmrPara.bkMod!=g_spiRcvData[0x00])
        {
            cmrPara.bkMod = g_spiRcvData[0x00];
            {g_dspUpdateFlag|=0x0001;};
        }
        
        if(cmrPara.cmpCode!=g_spiRcvData[0x07])
        {
            cmrPara.cmpCode = g_spiRcvData[0x07];            
...
void CameraCmdReply(u8 cmd)
{
    switch(cmd)
    {
      ...
      case 0xc0:
        if(0x00c1==((WORD) (((BYTE) (g_spiRcvData[1])) | ((WORD) ((BYTE) (g_spiRcvData[0]))) << 8)))
        {
      ...
      case 0xd0:
        ...
        {
            {GPIO_WriteBit(((GPIO_TypeDef *) (uint16_t)0x500A),GPIO_Pin_5,RESET);};
            g_isAfOn = 0;
        }else
        {
            {GPIO_WriteBit(((GPIO_TypeDef *) (uint16_t)0x500A),GPIO_Pin_5,SET);};
            g_isAfOn = 1;
        }
        g_datRcvFlag = 0;
...
void SpiSrIntProc(void)
{
    ...
    {
      case 0:
        g_cmdCode = ((SPI_TypeDef *) (uint16_t)0x5200)->DR;
        g_spiRcvIndex = 0;
      ...
      case 1:
        g_spiBuf = ((SPI_TypeDef *) (uint16_t)0x5200)->DR;
...
void SetSpiComModeOff(u8 mod, u8 aSel)
{
    ...
    switch(mod)
    {
      case 0:
        ...
        macData2[5] = cmp_calc[TTL_Ev_TypeDef+9];
        break;
        
      case 1:
        macData2[1] = 0x06;

        macData2[5]=output_calc[Flash_Output_Typedef+9];
        break;
        
      case 2:
        macData2[1] = 0x07;
        macData2[5]=output_calc[(*multiSet.expose>>4)*3];
        macData2[11] = mainPara.multi_times;
        macData2[10] = mainPara.multi_Frq;
        break;
...
{   
    switch(g_nikComStatue)
    {
      case 0x00:
        {
            if ((((((GPIO_TypeDef *) (uint16_t)0x5005)->IDR)>>4)&0x01) > 0)
            {
      ...
      case 0X03:
        {
            ...
            }else if (2 == g_sboPullFlag)
            {
                ...
                {
                    g_sboPullFlag = 0;
                    {{((SPI_TypeDef *) (uint16_t)0x5200)->CR1 &= ~0x40;((GPIO_TypeDef *) (uint16_t)0x5005)->DDR|=GPIO_Pin_6;}; (GPIO_WriteBit(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_6,SET));};                
                }
            }            
        }break;
      case 0x0E:
...
void FlashEventLoop(void)
{
    ...
    {        
        ...
        {            
            ...
            {{((SPI_TypeDef *) (uint16_t)0x5200)->CR1 &= ~0x40;((GPIO_TypeDef *) (uint16_t)0x5005)->DDR|=GPIO_Pin_6;}; (GPIO_WriteBit(((GPIO_TypeDef *) (uint16_t)0x5005), GPIO_Pin_6,RESET));};
            delay_us(400);
            { {((SPI_TypeDef *) (uint16_t)0x5200)->CR1 &= ~0x40;((GPIO_TypeDef *) (uint16_t)0x5005)->DDR|=GPIO_Pin_5;((GPIO_TypeDef *) (uint16_t)0x5005)->CR1|=GPIO_Pin_5;((GPIO_TypeDef *) (uint16_t)0x5005)->CR2|=GPIO_Pin_5;}; GPIO_WriteBit(((GPIO_TypeDef *) (uint16_t)0x5005),GPIO_Pin_5,RESET); };
            if (g_chargeOk > 0)
            {
