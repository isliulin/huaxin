...
const  _Camera_Zoom_TypeDef  Camera_Zoom_Data[] ={
    Camera_Zoom_18,
    Camera_Zoom_24,  
    Camera_Zoom_28,       
    Camera_Zoom_35,          
...
void Nikon_Zoom_Handler(void)
{
    if(M_Zoom_TypeDef == M_Zoom_AUTO)
    {        
        uint8_t Zoom_Value,count;
        
        Zoom_Value = cmrPara.focLen;
        ...
        Camera_Zoom_offset = count;
        
        Motor_Contorl_TypeDef.Motor_Value = Motor_Value_Data[Camera_Zoom_offset]; 
    }  
}

void Camera_Zoom_Handler(void)
{
    if(M_Zoom_TypeDef == M_Zoom_AUTO)
    {        
        uint8_t Zoom_Value,count;
        ...
        Zoom_Value = Moto_Zoom_Data[Camera_Zoom_offset];
