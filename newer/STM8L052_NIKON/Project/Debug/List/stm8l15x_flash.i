...
void FLASH_SetProgrammingTime(FLASH_ProgramTime_TypeDef FLASH_ProgTime)
{
  ...
  ((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 &= (uint8_t)(~((uint8_t)0x01));
  ((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 |= (uint8_t)FLASH_ProgTime;
}
...
FLASH_ProgramTime_TypeDef FLASH_GetProgrammingTime(void)
{
  return((FLASH_ProgramTime_TypeDef)(((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 & ((uint8_t)0x01)));
}
...
void FLASH_PowerWaitModeConfig(FLASH_Power_TypeDef FLASH_Power)
{
  ...
  {
    ((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 |= (uint8_t)((uint8_t)0x04);
  }
...
void FLASH_DeInit(void)
{
  ((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 = ((uint8_t)0x00);
  ((FLASH_TypeDef *) (uint16_t)0x5050)->CR2 = ((uint8_t)0x00);
  ((FLASH_TypeDef *) (uint16_t)0x5050)->IAPSR = ((uint8_t)0x40);
  (void) ((FLASH_TypeDef *) (uint16_t)0x5050)->IAPSR;  
}
...
void FLASH_Unlock(FLASH_MemType_TypeDef FLASH_MemType)
{
  ...
  {
    ((FLASH_TypeDef *) (uint16_t)0x5050)->PUKR = ((uint8_t)0x56);
    ((FLASH_TypeDef *) (uint16_t)0x5050)->PUKR = ((uint8_t)0xAE);
  }
  
   
  if(FLASH_MemType == FLASH_MemType_Data)
  {
    ((FLASH_TypeDef *) (uint16_t)0x5050)->DUKR = ((uint8_t)0xAE);  
    ((FLASH_TypeDef *) (uint16_t)0x5050)->DUKR = ((uint8_t)0x56);
  }
}
...
void FLASH_Lock(FLASH_MemType_TypeDef FLASH_MemType)
{
  ...
  ((FLASH_TypeDef *) (uint16_t)0x5050)->IAPSR &= (uint8_t)FLASH_MemType;
}
...
void FLASH_ProgramByte(uint32_t Address, uint8_t Data)
{
  ...
  *(__far uint8_t*) (uint32_t)Address = Data;
}
...
void FLASH_EraseByte(uint32_t Address)
{
  ...
  *(__far uint8_t*) (uint32_t)Address = ((uint8_t)0x00);  
}
...
void FLASH_ProgramWord(uint32_t Address, uint32_t Data)
{
  ...
  ((FLASH_TypeDef *) (uint16_t)0x5050)->CR2 |= ((uint8_t)0x40);
  
   
  *((__far uint8_t*)(uint32_t)Address)       = *((uint8_t*)(&Data));   
   
  *(((__far uint8_t*)(uint32_t)Address) + 1) = *((uint8_t*)(&Data) + 1);
   
  *(((__far uint8_t*)(uint32_t)Address) + 2) = *((uint8_t*)(&Data) + 2); 
   
  *(((__far uint8_t*)(uint32_t)Address) + 3) = *((uint8_t*)(&Data) + 3); 
}
...
uint8_t FLASH_ReadByte(uint32_t Address)
{
  ...
  return(*(__far uint8_t *) (uint32_t)Address);
}
...
void FLASH_ProgramOptionByte(uint16_t Address, uint8_t Data)
{
  ...
  ((FLASH_TypeDef *) (uint16_t)0x5050)->CR2 |= ((uint8_t)0x80);

   
  *((__far uint8_t*)Address) = Data;

  FLASH_WaitForLastOperation(FLASH_MemType_Program);

   
  ((FLASH_TypeDef *) (uint16_t)0x5050)->CR2 &= (uint8_t)(~((uint8_t)0x80));
}
...
void FLASH_EraseOptionByte(uint16_t Address)
{
  ...
  *((__far uint8_t*)Address) = ((uint8_t)0x00);
...
FunctionalState FLASH_GetReadOutProtectionStatus(void)
{
  ...
  if(((OPT_TypeDef *) (uint16_t)0x4800)->ROP == ((uint8_t)0xAA))
  {
...
uint16_t FLASH_GetBootSize(void)
{
  ...
  temp = (uint16_t)((uint16_t)((OPT_TypeDef *) (uint16_t)0x4800)->UBC * (uint16_t)128);
  
   
  if(((OPT_TypeDef *) (uint16_t)0x4800)->UBC > 0x7F)
  {
    temp = 8192;
  }
...
uint16_t FLASH_GetCodeSize(void)
{
  ...
  temp = (uint16_t)((uint16_t)((OPT_TypeDef *) (uint16_t)0x4800)->PCODESIZE * (uint16_t)128);
  
   
  if(((OPT_TypeDef *) (uint16_t)0x4800)->PCODESIZE > 0x7F)
  {
    temp = 8192;
  }
...
void FLASH_ITConfig(FunctionalState NewState)
{
  ...
  if(NewState != DISABLE)
  {
    ...
    ((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 |= ((uint8_t)0x02);
  }
  else
  {
     
    ((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 &= (uint8_t)(~((uint8_t)0x02));
  }
}
...
FlagStatus FLASH_GetFlagStatus(FLASH_FLAG_TypeDef FLASH_FLAG)
{
  ...
  if((((FLASH_TypeDef *) (uint16_t)0x5050)->IAPSR  & (uint8_t)FLASH_FLAG) != (uint8_t)RESET)
  {
    status = SET;  
  }
  else
...
void FLASH_PowerRunModeConfig(FLASH_Power_TypeDef FLASH_Power)
{
  ...
  if(FLASH_Power != FLASH_Power_On)
  {
    ((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 |= (uint8_t)((uint8_t)0x08);
  }
  else
  {
    ((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 &= (uint8_t)(~((uint8_t)0x08));
...
FLASH_PowerStatus_TypeDef FLASH_GetPowerStatus(void)
{
  return((FLASH_PowerStatus_TypeDef)(((FLASH_TypeDef *) (uint16_t)0x5050)->CR1 & (uint8_t)0x0C));
}
...
void FLASH_ProgramBlock(uint16_t BlockNum, FLASH_MemType_TypeDef FLASH_MemType, FLASH_ProgramMode_TypeDef FLASH_ProgMode, uint8_t *Buffer)
{
  ...
  {
    ((void)0);
    startaddress = ((uint32_t)0x00008000);
  }
  else
  {
    ((void)0);
  ...
  startaddress = startaddress + ((uint32_t)BlockNum * ((uint8_t)0x80));
  
   
  if(FLASH_ProgMode == FLASH_ProgramMode_Standard)
  {
     
    ((FLASH_TypeDef *) (uint16_t)0x5050)->CR2 |= ((uint8_t)0x01);
  }
  else
  {
     
    ((FLASH_TypeDef *) (uint16_t)0x5050)->CR2 |= ((uint8_t)0x10);
  }
  
   
  for(Count = 0; Count < ((uint8_t)0x80); Count++)
  {
    *((__far uint8_t*) (uint32_t)startaddress + Count) = ((uint8_t)(Buffer[Count]));
  }
}
...
void FLASH_EraseBlock(uint16_t BlockNum, FLASH_MemType_TypeDef FLASH_MemType)
{
  ...
  pwFlash = (__far uint8_t *)(uint32_t)(startaddress + ((uint32_t)BlockNum * ((uint8_t)0x80)));
  
   
  ((FLASH_TypeDef *) (uint16_t)0x5050)->CR2 |= ((uint8_t)0x20);
...
FLASH_Status_TypeDef FLASH_WaitForLastOperation(FLASH_MemType_TypeDef FLASH_MemType)
{
  uint16_t timeout = ((uint16_t)0xFFFF);
  ...
  if(FLASH_MemType == FLASH_MemType_Program)
  {
    ...
    {
      flagstatus = (uint8_t)(((FLASH_TypeDef *) (uint16_t)0x5050)->IAPSR & (uint8_t)(((uint8_t)0x04) |
                                                      ((uint8_t)0x01)));
      timeout--;
    }
  }
  else
  {
    while((flagstatus == 0x00) && (timeout != 0x00))
    {
      flagstatus = (uint8_t)(((FLASH_TypeDef *) (uint16_t)0x5050)->IAPSR & (uint8_t)(((uint8_t)0x40) |
                                                      ((uint8_t)0x01)));
      timeout--;
    }
  }
