...
void WWDG_Init(uint8_t Counter, uint8_t WindowValue)
{
  ...
  ((WWDG_TypeDef *) (uint16_t)0x50D3)->WR = ((uint8_t)0x7F);
  ((WWDG_TypeDef *) (uint16_t)0x50D3)->CR = (uint8_t)(((uint8_t)0x80) | Counter);
  ((WWDG_TypeDef *) (uint16_t)0x50D3)->WR = (uint8_t)((uint8_t)((uint8_t)0x7F) & (uint8_t) WindowValue);
}
...
void WWDG_SetWindowValue(uint8_t WindowValue)
{
  ...
  tmpreg |= (uint8_t) (WindowValue & (uint8_t) ((uint8_t)0x7F));

   
  ((WWDG_TypeDef *) (uint16_t)0x50D3)->WR = tmpreg;
}
...
void WWDG_SetCounter(uint8_t Counter)
{
  ...
  ((WWDG_TypeDef *) (uint16_t)0x50D3)->CR = (uint8_t)(Counter & (uint8_t)((uint8_t)0x7F));
}
...
uint8_t WWDG_GetCounter(void)
{
  return(((WWDG_TypeDef *) (uint16_t)0x50D3)->CR);
}
...
void WWDG_SWReset(void)
{
  ((WWDG_TypeDef *) (uint16_t)0x50D3)->CR = ((uint8_t)0x80);  
}
