...
FlagStatus RST_GetFlagStatus(RST_FLAG_TypeDef RST_Flag)
{
  ...
  return((FlagStatus)(((uint8_t)(((RST_TypeDef *) (uint16_t)0x50B0)->SR & RST_Flag) == (uint8_t)0x00) ? RESET : SET));
}
...
void RST_ClearFlag(RST_FLAG_TypeDef RST_Flag)
{
  ...
  ((RST_TypeDef *) (uint16_t)0x50B0)->SR = (uint8_t)RST_Flag;
}
...
void RST_GPOutputEnable(void)
{
  ...
  ((RST_TypeDef *) (uint16_t)0x50B0)->CR = 0xD0;
}
