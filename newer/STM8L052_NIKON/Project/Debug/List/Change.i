...
void Change_Cap(void)           
{
    ...
    {
        if(ADC_VALUE.Channel_CAP_VALUE > 3383)
        {
            {TIM5_CtrlPWMOutputs(DISABLE);GPIO_ResetBits(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_6);};
        }
        else if(ADC_VALUE.Channel_CAP_VALUE < 3383-100)
        {
            if(ADC_VALUE.Channel_CAP_VALUE < 1743)
            {
                GPIO_ResetBits(((GPIO_TypeDef *) (uint16_t)0x500A), GPIO_Pin_3);
            }
            else if(ADC_VALUE.Channel_CAP_VALUE > 1743+20)
            {
