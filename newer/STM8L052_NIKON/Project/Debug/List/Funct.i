...
void Nikon_To_Camera(void)
{
    switch(Sys_Mode_Typedef)
    {
      case Sys_Mode_TTL:mainPara.workMode = 0;  break;
      case Sys_Mode_M:  mainPara.workMode = 1; break;
      case Sys_Mode_RPT:mainPara.workMode = 2;break;
      default:mainPara.workMode = 1; break;
    }
}
