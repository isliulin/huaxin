...
void I2C_DeInit(I2C_TypeDef* I2Cx)
{
  I2Cx->CR1 = ((uint8_t)0x00);
  I2Cx->CR2 = ((uint8_t)0x00);
  I2Cx->FREQR = ((uint8_t)0x00);
  I2Cx->OARL = ((uint8_t)0x00);
  I2Cx->OARH = ((uint8_t)0x00);
  I2Cx->OAR2 = ((uint8_t)0x00);
  I2Cx->ITR = ((uint8_t)0x00);
  I2Cx->CCRL = ((uint8_t)0x00);
  I2Cx->CCRH = ((uint8_t)0x00);
  I2Cx->TRISER = ((uint8_t)0x02);
}
              ...
              I2C_Ack_TypeDef I2C_Ack, I2C_AcknowledgedAddress_TypeDef I2C_AcknowledgedAddress)
{
  ...
  I2Cx->FREQR &= (uint8_t)(~((uint8_t)0x3F));
   
  I2Cx->FREQR |= input_clock;

   
   
  I2Cx->CR1 &= (uint8_t)(~((uint8_t)0x01));

   
  I2Cx->CCRH &= (uint8_t)(~(((uint8_t)0x80) | ((uint8_t)0x40) | ((uint8_t)0x0F)));
  I2Cx->CCRL &= (uint8_t)(~((uint8_t)0xFF));

   
  if (OutputClockFrequency > ((uint32_t)100000))  
  {
     
    tmpccrh = ((uint8_t)0x80);
  ...
  I2Cx->CCRH = (uint8_t)((uint8_t)((uint8_t)((uint8_t)result >> 8) & ((uint8_t)0x0F)) | tmpccrh);

   
  I2Cx->CR1 |= (uint8_t)(((uint8_t)0x01) | I2C_Mode);
  ...
  I2Cx->OARH = (uint8_t)((uint8_t)(I2C_AcknowledgedAddress | ((uint8_t)0x40) ) |                          (uint8_t)((uint16_t)( (uint16_t)OwnAddress &  (uint16_t)0x0300) >> 7));
}
...
void I2C_GeneralCallCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1 |= ((uint8_t)0x40);
  }
  else  
  {
     
    I2Cx->CR1 &= (uint8_t)(~((uint8_t)0x40));
  }
}
...
void I2C_GenerateSTART(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2 |= ((uint8_t)0x01);
  }
  else  
  {
     
    I2Cx->CR2 &= (uint8_t)(~((uint8_t)0x01));
  }
}
...
void I2C_GenerateSTOP(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2 |= ((uint8_t)0x02);
  }
  else  
  {
     
    I2Cx->CR2 &= (uint8_t)(~((uint8_t)0x02));
  }
}
...
void I2C_SoftwareResetCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2 |= ((uint8_t)0x80);
  }
  else  
  {
     
    I2Cx->CR2 &= (uint8_t)(~((uint8_t)0x80));
  }
}
...
void I2C_StretchClockCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1 &= (uint8_t)(~((uint8_t)0x80));

  }
  else  
  {
     
    I2Cx->CR1 |= ((uint8_t)0x80);
  }
}
...
void I2C_ARPCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1 |= ((uint8_t)0x10);

  }
  else  
  {
     
    I2Cx->CR1 &= (uint8_t)(~((uint8_t)0x10));
  }
}
...
void I2C_AcknowledgeConfig(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2 |= ((uint8_t)0x04);
  }
  else
  {
     
    I2Cx->CR2 &= (uint8_t)(~((uint8_t)0x04));
  }
}
...
void I2C_DualAddressCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->OAR2 &= (uint8_t)(~((uint8_t)0x01));
  }
}
...
void I2C_FastModeDutyCycleConfig(I2C_TypeDef* I2Cx, I2C_DutyCycle_TypeDef I2C_DutyCycle)
{
  ...
  if (I2C_DutyCycle == I2C_DutyCycle_16_9)
  {
    ...
    I2Cx->CCRH |= ((uint8_t)0x40);
  }
  else  
  {
     
    I2Cx->CCRH &= (uint8_t)(~((uint8_t)0x40));
  }
}
...
void I2C_TransmitPEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2 |= ((uint8_t)0x10);
  }
  else
  {
     
    I2Cx->CR2 &= (uint8_t)(~((uint8_t)0x10));
  }
}
...
void I2C_CalculatePEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1 |= ((uint8_t)0x20);
  }
  else
  {
     
    I2Cx->CR1 &= (uint8_t)(~((uint8_t)0x20));
  }
}
...
void I2C_DMACmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->ITR |= ((uint8_t)0x08);
  }
  else
  {
     
    I2Cx->ITR &= (uint8_t)(~((uint8_t)0x08));
  }
}
...
void I2C_DMALastTransferCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->ITR |= ((uint8_t)0x10);
  }
  else
  {
     
    I2Cx->ITR &= (uint8_t)(~((uint8_t)0x10));
  }
}
...
ErrorStatus I2C_CheckEvent(I2C_TypeDef* I2Cx, I2C_Event_TypeDef I2C_Event)
{
  ...
  {
    lastevent = I2Cx->SR2 & ((uint8_t)0x04);
  }
  else
  {
    flag1 = I2Cx->SR1;
...
void I2C_ClearFlag(I2C_TypeDef* I2Cx, I2C_FLAG_TypeDef I2C_FLAG)
{
  ...
  flagpos = (uint16_t)I2C_FLAG & ((uint16_t)0x00FF);
...
ITStatus I2C_GetITStatus(I2C_TypeDef* I2Cx, I2C_IT_TypeDef I2C_IT)
{
  ...
  tempregister = (uint8_t)( ((uint16_t)((uint16_t)I2C_IT & ((uint16_t)0x0700))) >> 8);

   
  enablestatus = (uint8_t)(I2Cx->ITR & ( uint8_t)tempregister);

  if ((uint16_t)((uint16_t)I2C_IT & ((uint16_t)0x3000)) == ((uint16_t)0x0100))
  {
...
void I2C_ClearITPendingBit(I2C_TypeDef* I2Cx, I2C_IT_TypeDef I2C_IT)
{
  ...
  flagpos = (uint16_t)I2C_IT & ((uint16_t)0x00FF);
