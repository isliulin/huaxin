...
void DMA_GlobalDeInit(void)
{
  ...
  ((DMA_TypeDef *) (uint16_t)0x5070)->GCSR &= (uint8_t)~(((uint8_t)0x01));

   
  ((DMA_TypeDef *) (uint16_t)0x5070)->GCSR  = (uint8_t)((uint8_t)0xFC);
}
...
void DMA_DeInit(DMA_Channel_TypeDef* DMA_Channelx)
{
  ...
  DMA_Channelx->CCR &= (uint8_t)~(((uint8_t)0x01));

   
  DMA_Channelx->CCR  = ((uint8_t)0x00);

   
  DMA_Channelx->CNBTR = ((uint8_t)0x00);

   
  if (DMA_Channelx == ((DMA_Channel_TypeDef *) (uint16_t)0x5093))
  {
    DMA_Channelx->CPARH  = ((uint8_t)0x40);
    DMA_Channelx->CM0EAR = ((uint8_t)0x00);
  }
  else
  {
    DMA_Channelx->CPARH  = ((uint8_t)0x52);
  }
  DMA_Channelx->CPARL  = ((uint8_t)0x00);

   
  DMA_Channelx->CM0ARH = ((uint8_t)0x00);
  DMA_Channelx->CM0ARL = ((uint8_t)0x00);

   
  DMA_Channelx->CSPR = ((uint8_t)0x00);
}
              ...
              DMA_MemoryDataSize_TypeDef DMA_MemoryDataSize )
{
  ...
  DMA_Channelx->CSPR &= (uint8_t)(~(uint8_t)(((uint8_t)0x30) | ((uint8_t)0x08)));
...
void DMA_SetTimeOut(uint8_t DMA_TimeOut)
{
  ...
  ((DMA_TypeDef *) (uint16_t)0x5070)->GCSR = 0;
  ((DMA_TypeDef *) (uint16_t)0x5070)->GCSR = (uint8_t)(DMA_TimeOut << (uint8_t)2);
...
FlagStatus DMA_GetFlagStatus(DMA_FLAG_TypeDef DMA_FLAG)
{
  ...
  DMA_Channel_TypeDef* DMA_Channelx =  ((DMA_Channel_TypeDef *) (uint16_t)0x5075);
  uint8_t tmpgir1 = 0;
  uint8_t tmpgcsr = 0;
  ...
  tmpgcsr = ((DMA_TypeDef *) (uint16_t)0x5070)->GCSR;
  tmpgir1 = ((DMA_TypeDef *) (uint16_t)0x5070)->GIR1;
  ...
  if (((uint16_t)DMA_FLAG & (uint16_t)0x0F00) != (uint16_t)RESET)
  {
    ...
    {
      DMA_Channelx = ((DMA_Channel_TypeDef *) (uint16_t)0x5075);
    }
    else if  (((uint16_t)DMA_FLAG & 0x0200) != (uint16_t)RESET)
    {
      DMA_Channelx = ((DMA_Channel_TypeDef *) (uint16_t)0x507F);
    }
    else if  (((uint16_t)DMA_FLAG & 0x0400) != (uint16_t)RESET)
    {
      DMA_Channelx = ((DMA_Channel_TypeDef *) (uint16_t)0x5089);
    }
    else
    {
      DMA_Channelx = ((DMA_Channel_TypeDef *) (uint16_t)0x5093);
    }
  ...
  else  
  {
    ...
    flagstatus = (FlagStatus)(tmpgcsr & ((uint8_t)0x02));
  }
...
ITStatus DMA_GetITStatus(DMA_IT_TypeDef DMA_IT)
{
  ...
  tmp2 = (uint8_t)(DMA_IT & (uint8_t)(((uint8_t)0x02) | ((uint8_t)0x04)));
