...
void AES_DeInit(void)
{
  ...
  ((AES_TypeDef *) (uint16_t)0x53D0)->CR = ((uint8_t)0x10) | ((uint8_t)0x08);
  ((AES_TypeDef *) (uint16_t)0x53D0)->DINR = ((uint8_t)0x00);        
  ((AES_TypeDef *) (uint16_t)0x53D0)->DOUTR = ((uint8_t)0x00);      
}
...
void AES_OperationModeConfig(AES_Operation_TypeDef AES_Operation)
{
  ...
  ((AES_TypeDef *) (uint16_t)0x53D0)->CR &= (uint8_t) (~((uint8_t)0x06));

   
  ((AES_TypeDef *) (uint16_t)0x53D0)->CR |= (uint8_t) (AES_Operation);
}
...
void AES_Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((AES_TypeDef *) (uint16_t)0x53D0)->CR |= (uint8_t) ((uint8_t)0x01);    
  }
  else
  {
    ((AES_TypeDef *) (uint16_t)0x53D0)->CR &= (uint8_t)(~((uint8_t)0x01));   
...
void AES_WriteSubData(uint8_t Data)
{
  ...
  ((AES_TypeDef *) (uint16_t)0x53D0)->DINR = Data;
}
...
void AES_WriteSubKey(uint8_t Key)
{
  ...
  ((AES_TypeDef *) (uint16_t)0x53D0)->DINR = Key;
}
...
uint8_t AES_ReadSubData(void)
{
  return ((AES_TypeDef *) (uint16_t)0x53D0)->DOUTR;
}
...
void AES_DMAConfig(AES_DMATransfer_TypeDef AES_DMATransfer, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((AES_TypeDef *) (uint16_t)0x53D0)->CR |= (uint8_t) AES_DMATransfer;
  }
  else
  {
...
void AES_ITConfig(AES_IT_TypeDef AES_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((AES_TypeDef *) (uint16_t)0x53D0)->CR |= (uint8_t) AES_IT;     
  }
  else
  {
    ((AES_TypeDef *) (uint16_t)0x53D0)->CR &= (uint8_t)(~AES_IT);   
...
FlagStatus AES_GetFlagStatus(AES_FLAG_TypeDef AES_FLAG)
{
  ...
  {
    if ((((AES_TypeDef *) (uint16_t)0x53D0)->SR & (uint8_t)AES_FLAG_CCF) != (uint8_t)0x00)
    {
  ...
  {
    if ((((AES_TypeDef *) (uint16_t)0x53D0)->SR & (uint8_t)AES_FLAG_RDERR) != (uint8_t)0x00)
    {
  ...
  {
    if ((((AES_TypeDef *) (uint16_t)0x53D0)->SR & (uint8_t)AES_FLAG_WRERR) != (uint8_t)0x00)
    {
...
void AES_ClearFlag(AES_FLAG_TypeDef AES_FLAG)
{
  ...
  if (AES_FLAG == AES_FLAG_CCF)
  {
    ...
    ((AES_TypeDef *) (uint16_t)0x53D0)->CR |= (uint8_t) ((uint8_t)0x08);
  }
  else  
  {
     
    ((AES_TypeDef *) (uint16_t)0x53D0)->CR |= (uint8_t) ((uint8_t)0x10);
  }
}
...
ITStatus AES_GetITStatus(AES_IT_TypeDef AES_IT)
{
  ...
  cciebitstatus = (BitStatus) (((AES_TypeDef *) (uint16_t)0x53D0)->CR & ((uint8_t)0x20));
  ccfbitstatus =  (BitStatus) (((AES_TypeDef *) (uint16_t)0x53D0)->SR & ((uint8_t)0x01));
  ...
  else  
  {
    ...
    if ((((AES_TypeDef *) (uint16_t)0x53D0)->CR & ((uint8_t)0x40)) != RESET)
    {
       
      if ((((AES_TypeDef *) (uint16_t)0x53D0)->SR & (uint8_t)(((uint8_t)0x04) | ((uint8_t)0x02))) != RESET)
      {
