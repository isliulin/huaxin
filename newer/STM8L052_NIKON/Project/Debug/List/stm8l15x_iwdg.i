...
void IWDG_WriteAccessCmd(IWDG_WriteAccess_TypeDef IWDG_WriteAccess)
{
  ...
  ((void)0);
  ((IWDG_TypeDef *) (uint16_t)0x50E0)->KR = IWDG_WriteAccess;  
}
...
void IWDG_SetPrescaler(IWDG_Prescaler_TypeDef IWDG_Prescaler)
{
  ...
  ((void)0);
  ((IWDG_TypeDef *) (uint16_t)0x50E0)->PR = IWDG_Prescaler;
}
...
void IWDG_SetReload(uint8_t IWDG_Reload)
{
  ((IWDG_TypeDef *) (uint16_t)0x50E0)->RLR = IWDG_Reload;
}
...
void IWDG_ReloadCounter(void)
{
  ((IWDG_TypeDef *) (uint16_t)0x50E0)->KR = ((uint8_t)0xAA);
}
...
void IWDG_Enable(void)
{
  ((IWDG_TypeDef *) (uint16_t)0x50E0)->KR = ((uint8_t)0xCC);
}
