...
void EXTI_DeInit(void)
{
  ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 = ((uint8_t)0x00);
  ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 = ((uint8_t)0x00);
  ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR3 = ((uint8_t)0x00);
  ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR4 = ((uint8_t)0x00);
  ((EXTI_TypeDef *) (uint16_t)0x50A0)->SR1 = 0xFF;  
  ((EXTI_TypeDef *) (uint16_t)0x50A0)->SR2 = 0xFF;  
  ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF1 = ((uint8_t)0x00);
  ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF2 = ((uint8_t)0x00);
}
...
void EXTI_SetPinSensitivity(EXTI_Pin_TypeDef EXTI_Pin, EXTI_Trigger_TypeDef EXTI_Trigger)
{
  ...
  {
    case EXTI_Pin_0:
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 &=  (uint8_t)(~((uint8_t)0x03));
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
      break;
    case EXTI_Pin_1:
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 &=  (uint8_t)(~((uint8_t)0x0C));
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
      break;
    case EXTI_Pin_2:
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 &=  (uint8_t)(~((uint8_t)0x30));
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
      break;
    case EXTI_Pin_3:
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 &=  (uint8_t)(~((uint8_t)0xC0));
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
      break;
    case EXTI_Pin_4:
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 &=  (uint8_t)(~((uint8_t)0x03));
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
      break;
    case EXTI_Pin_5:
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 &=  (uint8_t)(~((uint8_t)0x0C));
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
      break;
    case EXTI_Pin_6:
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 &=  (uint8_t)(~((uint8_t)0x30));
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
      break;
    case EXTI_Pin_7:
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 &=  (uint8_t)(~((uint8_t)0xC0));
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
      break;
    default:
      break;
...
void EXTI_SelectPort(EXTI_Port_TypeDef EXTI_Port)
{
  ...
  if (EXTI_Port == EXTI_Port_B)
  {
    ...
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF2 &= (uint8_t) (~((uint8_t)0x20));
  }
  else if (EXTI_Port == EXTI_Port_D)
  {
     
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF2 &= (uint8_t) (~((uint8_t)0x40));
  }
  else if (EXTI_Port == EXTI_Port_E)
  {
     
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF1 &= (uint8_t) (~((uint8_t)0x80));
  }
                               ...
                               FunctionalState NewState)
{
  ...
  if ((EXTI_HalfPort & 0x80) == 0x00)
  {
    if (NewState != DISABLE)
    {
      ...
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF1 |= (uint8_t)EXTI_HalfPort;
    }
    else  
    {
       
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF1 &= (uint8_t)(~(uint8_t)EXTI_HalfPort);
    }
  }
  else
  {
    if (NewState != DISABLE)
    {
      ...
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF2 |= (uint8_t)(EXTI_HalfPort & (uint8_t)0x7F);
    }
    else  
    {
       
      ((EXTI_TypeDef *) (uint16_t)0x50A0)->CONF2 &= (uint8_t)(~(uint8_t) (EXTI_HalfPort & (uint8_t)0x7F));
    }
  }
}
                             ...
                             EXTI_Trigger_TypeDef EXTI_Trigger)
{
  ...
  if ((EXTI_Port & 0xF0) == 0x00)
  {
    ...
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR3 &= (uint8_t) (~(uint8_t)((uint8_t)0x03 << EXTI_Port));
     
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR3 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Port);
  }
  else  
  {
     
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR4 &= (uint8_t) (~(uint8_t)((uint8_t)0x03 << (EXTI_Port & 0x0F)));
     
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->CR4 |= (uint8_t)(EXTI_Trigger << (EXTI_Port & 0x0F));
  }
}
...
EXTI_Trigger_TypeDef EXTI_GetPinSensitivity(EXTI_Pin_TypeDef EXTI_Pin)
{
  ...
  {
    case EXTI_Pin_0:
      value = (uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 & ((uint8_t)0x03));
      break;
    case EXTI_Pin_1:
      value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 & ((uint8_t)0x0C)) >> EXTI_Pin_1);
      break;
    case EXTI_Pin_2:
      value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 & ((uint8_t)0x30)) >> EXTI_Pin_2);
      break;
    case EXTI_Pin_3:
      value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR1 & ((uint8_t)0xC0)) >> EXTI_Pin_3);
      break;
    case EXTI_Pin_4:
      value = (uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 & ((uint8_t)0x03));
      break;
    case EXTI_Pin_5:
      value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 & ((uint8_t)0x0C)) >> ((uint8_t)EXTI_Pin_5 & (uint8_t)0x0F));
      break;
    case EXTI_Pin_6:
      value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 & ((uint8_t)0x30)) >> ((uint8_t)EXTI_Pin_6 & (uint8_t)0x0F));
      break;
    case EXTI_Pin_7:
      value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR2 & ((uint8_t)0xC0)) >> ((uint8_t)EXTI_Pin_7 & (uint8_t)0x0F));
      break;
    default:
      break;
  }
...
EXTI_Trigger_TypeDef EXTI_GetPortSensitivity(EXTI_Port_TypeDef EXTI_Port)
{
  ...
  if ((EXTI_Port & 0xF0) == 0x00)
  {
    ...
    portsensitivity = (uint8_t)((uint8_t)0x03 & (uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR3 >> EXTI_Port));
  }
   
  else
  {
     
    portsensitivity = (uint8_t)((uint8_t)0x03 & (uint8_t)(((EXTI_TypeDef *) (uint16_t)0x50A0)->CR4 >> (EXTI_Port & 0x0F)));
  }
...
ITStatus EXTI_GetITStatus(EXTI_IT_TypeDef EXTI_IT)
{
  ...
  {
    status = (ITStatus)(((EXTI_TypeDef *) (uint16_t)0x50A0)->SR2 & (uint8_t)((uint16_t)EXTI_IT & (uint16_t)0x00FF));
  }
  else
  {
    status = (ITStatus)(((EXTI_TypeDef *) (uint16_t)0x50A0)->SR1 & ((uint8_t)((uint16_t)EXTI_IT & (uint16_t)0x00FF)));
  }
...
void EXTI_ClearITPendingBit(EXTI_IT_TypeDef EXTI_IT)
{
  ...
  if ( tempvalue == 0x0100)
  {
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->SR2 = (uint8_t)((uint16_t)EXTI_IT & (uint16_t)0x00FF);
  }
  else
  {
    ((EXTI_TypeDef *) (uint16_t)0x50A0)->SR1 = (uint8_t) (EXTI_IT);
  }
}
