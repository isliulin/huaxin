...
#define GET_FIRMWARE_VERSION		0x00
...
#define AM1_IAP_SECKEY_PROG			0x52
#define AM1_IAP_SECTOR_PROTECT		0x53

#define AM1_IAP_JUMP_UPDATE			0Xfc
#define AM1_IAP_UARTSHUT			0Xfd
...
protected:
	...
	static void ComfirmProc(unsigned char* rcv);
