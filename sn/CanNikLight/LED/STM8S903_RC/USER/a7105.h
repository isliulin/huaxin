...
#define A7105_IDR()    ((GPIOC->IDR>>7)&0X01)//GPIO_ReadInputPin(GPIOC, GPIO_PIN_6)//GPIO_ReadInputPin(GPIOC, GPIO_PIN_7)
//#define A7105_DDR(x)   GPIO_WriteDdrBit(GPIOC, GPIO_PIN_6, x)
#define A7105_IRQ()    GPIO_ReadInputPin(GPIOC, GPIO_PIN_3)
#define A7105_RX_AF(x)  GPIO_WriteBit(GPIOE, GPIO_PIN_5 ,x)
#define A7107_TX_AF(x)  GPIO_WriteBit(GPIOB, GPIO_PIN_0 ,x)
