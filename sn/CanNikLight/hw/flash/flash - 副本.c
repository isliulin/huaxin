...
#endif
		printf("ad: %d, vol: %d, pra :%d\r\n", g_volRef, AdToVol(g_volRef),ttl_pre_dbg);
		printf("ttl: %x, %x, %x, %d\r\n",g_expTTLPara1,g_expTTLPara2,ttl_expCodeRsv,g_flashTime);
		//printf("ttl: %x, %x, %x, %d\r\n",g_expTTLPara1,g_expTTLPara2,ttl_expCodeRsv,g_flashTime);
...
#define TTL_VAL_MIN 50//0x32//0x26//0x23//0x1d//0x32//0x54
...
void NikExpCalSub(const u8 i_code)
{
	...
	}else if (i_code < (TTL_VAL_MIN+6))
	{
		g_expTTLPara1 = -3;                          // 20171026
		g_expTTLPara2 = 2;
	}else if(i_code < (TTL_VAL_MIN+9))
	{
		g_expTTLPara1 = -2;                          // 20171026
		g_expTTLPara2 = 0;
	}else if (i_code < (TTL_VAL_MIN+12))
	{
		g_expTTLPara1 = -2;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+15))
	{
		g_expTTLPara1 = -2;                          // 20171026
		g_expTTLPara2 = 2;
	}else if (i_code < (TTL_VAL_MIN+18))
	{
		g_expTTLPara1 = -1;                          // 20171026
		g_expTTLPara2 = 0;
	}else if (i_code < (TTL_VAL_MIN+21))
	{
		g_expTTLPara1 = -1;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+24))
	{
		g_expTTLPara1 = -1;                          // 20171026
		g_expTTLPara2 = 2;
	}else if (i_code < (TTL_VAL_MIN+27))
	{
		g_expTTLPara1 = 0;                          // 20171026
		g_expTTLPara2 = 0;
	}
	else if (i_code < (TTL_VAL_MIN+30))
	{
		g_expTTLPara1 = 0;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+33))
	{
		g_expTTLPara1 = 0;                          // 20171026
		g_expTTLPara2 = 2;
	}else if (i_code < (TTL_VAL_MIN+36))
	{
		g_expTTLPara1 = 1;                          // 20171026
		g_expTTLPara2 = 0;
	}
	else if (i_code < (TTL_VAL_MIN+39))
	{
		g_expTTLPara1 = 1;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+42))
	{
		g_expTTLPara1 = 1;                          // 20171026
		g_expTTLPara2 = 2;
	}else if (i_code < (TTL_VAL_MIN+45))
	{
		g_expTTLPara1 = 2;                          // 20171026
		g_expTTLPara2 = 0;
	}else if (i_code < (TTL_VAL_MIN+48))
	{
		g_expTTLPara1 = 2;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+51))
	{
		g_expTTLPara1 = 2;                          // 20171026
		g_expTTLPara2 = 2;
	}else if (i_code < (TTL_VAL_MIN+54))
	{
		g_expTTLPara1 = 3;                          // 20171026
		g_expTTLPara2 = 0;
	}else if (i_code < (TTL_VAL_MIN+57))
	{
		g_expTTLPara1 = 3;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+60))
	{
		g_expTTLPara1 = 3;                          // 20171026
		g_expTTLPara2 = 2;
	}else if (i_code < (TTL_VAL_MIN+63))
	{
		g_expTTLPara1 = 4;                          // 20171026
		g_expTTLPara2 = 0;
	}else if (i_code < (TTL_VAL_MIN+66))
	{
		g_expTTLPara1 = 4;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+69))
	{
		g_expTTLPara1 = 4;                          // 20171026
		g_expTTLPara2 = 2;
	}else if (i_code < (TTL_VAL_MIN+72))
	{
		g_expTTLPara1 = 5;                          // 20171026
		g_expTTLPara2 = 0;
	}else if (i_code < (TTL_VAL_MIN+75))
	{
		g_expTTLPara1 = 5;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+78))
	{
		g_expTTLPara1 = 5;                          // 20171026
		g_expTTLPara2 = 2;
	}else if (i_code < (TTL_VAL_MIN+81))
	{
		g_expTTLPara1 = 6;                          // 20171026
		g_expTTLPara2 = 0;
	}else if (i_code < (TTL_VAL_MIN+84))
	{
		g_expTTLPara1 = 6;                          // 20171026
		g_expTTLPara2 = 1;
	}else if (i_code < (TTL_VAL_MIN+87))
	{
		g_expTTLPara1 = 6;                          // 20171026
		g_expTTLPara2 = 2;
	}else
