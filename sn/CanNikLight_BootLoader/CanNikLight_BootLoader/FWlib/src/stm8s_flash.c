...
void FLASH_ProgramWord(uint32_t Address, uint32_t Data)
{
    ...
    *((PointerAttr uint8_t*)(uint32_t)Address)       = *((uint8_t*)(&Data));
    /* Write one byte*/
    *(((PointerAttr uint8_t*)(uint32_t)Address) + 1) = *((uint8_t*)(&Data)+1); 
    /* Write one byte*/    
    *(((PointerAttr uint8_t*)(uint32_t)Address) + 2) = *((uint8_t*)(&Data)+2); 
    /* Write one byte - from higher address*/
    *(((PointerAttr uint8_t*)(uint32_t)Address) + 3) = *((uint8_t*)(&Data)+3); 
}
