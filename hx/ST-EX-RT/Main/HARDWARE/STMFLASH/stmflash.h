...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//用户根据自己的需要设置
#define STM32_FLASH_SIZE 128//512 	 		//所选STM32的FLASH容量大小(单位为K)
...
//#define FLASH_VERI_FLAG_ADDR     (FLASH_SERNUM_ADDR+16)
#define FLASH_VERI_FLAG_ADDR     (FLASH_VER_ADDR+16+16)
#define FLASH_VERI_SN_ADDR         (FLASH_VERI_FLAG_ADDR+2)
//#define FLASH_BOOT_UP			(FLASH_SERNUM_ADDR+16)
//#define FLASH_USER_ADDR		(FLASH_SERNUM_ADDR+16)
#define FLASH_USER_ADDR		(0x0801E000+1024)

//FLASH起始地址
#define STM32_FLASH_BASE 0x08000000 	//STM32 FLASH的起始地址
#define STM32_BOOT_BASE 0x08000000
//FLASH解锁键值
